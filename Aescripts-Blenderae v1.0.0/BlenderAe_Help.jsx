...
(function () {
  function a(vars) {
    ...
    var maxUIButtons = 3;
    var licV = 2;
    var mx = __BLOB__BLOB_000004__;
    var wx = __BLOB__BLOB_000005__;
  ...
  var af_settings = {
    betaExpirationDate: new Date("Aug 22, 2021"),
    betaStartDate: new Date("Jul 31, 2021"),
    betaSupportEmail: "daniel@saltmedia.net",
    helpButtons: [],
    helpText:
      "\'BlenderAe\' is a Blender addon that allows you to export Blender data into After Effects. \n \nInstallation: \n \nTo install the addon in Blender go to \'Edit > Preferences > Addons\' and click \'Install...\'.\n \n \nUsage: \n \n1. With After Effects opened, click \'Connect to Ae\'. \n \n2. Make selections in Blender \n \nSupported selections in \'Object Mode\': Cameras (Ae Cameras), Lights (Ae Lights), Objects (Nulls), Planes (PreComped Shape layers). \n \nSupported selections in \'Edit Mode\': Vertices (Nulls), Faces (PreComped Shape layers). \n \n3. Click \'Export to Ae\'.\n\n \nKnown Issues: \n \n- A large number of selections, or long frame duration, can take a very long time to process (face selection currently takes the longest amount of time to process). Press \'esc\' to abort the import process. \n \n- Non-planar Faces (in Edit Mode) and non-planar Planes (in Object Mode) are not currently supported. \n \n- If the \u2018Ae Path\u2019 field contains a correct path but After Effects is not open, After Effects will open and close without saving. \n \n- Some modifiers can disrupt exporting of face and vertex data.\n\n \nExport and Import manually: \n \nWhen the \'Ae Path\' field is empty BlenderAe will still save the Blender data in the users \u2018Documents\\BlenderAe\u2019 folder. \n \nThis data can be imported into After Effects manually by going to \u2018File > Scripts > Run Script\u2019 and selecting the \u2018BlenderAe_Import.jsxbin\u2019 file that was included in the download. \n \nImportant Note \u2013  this will only work if the \u2018BlenderAe_data.json\u2019 is located in the \u2018Documents\\BlenderAe\u2019 folder.",
    offerBeta: false,
    offerTrial: true,
    privateNumber: 7646555551687322,
    productSKU: "SAMBE-SUL",
    scriptAuthor: "Salt Media",
    scriptName: "BlenderAe",
    scriptURL: "https://aescripts.com/blenderae",
    scriptVersion: "1.0.0",
  };
  var smBAe1 = new a(af_settings);
  if (smBAe1.c()) {
    smBAe1.helpUI();
  }
})();
