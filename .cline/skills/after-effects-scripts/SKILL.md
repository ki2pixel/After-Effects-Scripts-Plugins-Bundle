...
### Scripts Clés
- `MédiaSolution/preprocess_ae_json.py` - Moteur STEP7
- `PyShiftBridge/mediasolution/` - Ponts Python modernes (Hybrid 2.0)
- `MédiaSolution/media_solution_bridge.py` - Pont Python legacy
- `MédiaSolution/Media-Solution-v11.2-production.jsx` - Script principal
- `MédiaSolution/Analyse-Écart-X-depuis-JSON-et-Label-Vidéo36_good.jsx` - Recentrage
