...
function MM_BorderPatrol(thisObj) {
  var k4_settings = {
    betaExpirationDate: new Date("Dec 1, 2020"),
    betaStartDate: new Date("Nov 1, 2017"),
    betaSupportEmail: "joedeveloper@me.com",
    helpButtons: [
      { name: "BorderPatrol", url: "https://aescripts.com/borderpatrol" },
      { name: "YouTube", url: "https://youtube.com/motionmethods" },
      { name: "Instagram", url: "https://www.instagram.com/motionmethods" },
    ],
    helpText:
      "BorderPatrol provides a painless way to resize shapes while maintaining stroke widths and rounded corners. All you need to do is adjust the shape layer\u2019s scale property and shapes will resize relative to the layer\u2019s anchor point. BorderPatrol works with both Parametric and Bezier Path shapes.\n\n[  How to use  ]\n1. Select some shape layer(s).\n2. Choose a new location for the anchor point or click \u201cLeave Anchor\u201d to leave the anchor point where it is.\n3. Adjust the layer\u2019s scale property.\n\n[  Collapse Stroke Option  ]\nEnable this when you want to smoothly scale the stroke width to and from 0%. The stroke width will only animate when the shape size is less than the stroke width.\n\n[  Notes  ]\n1. Make sure strokes are inside the shape group. Strokes outside shape groups will not maintain their width.\n2. When using with Polygon and Star shapes layers make sure \u201cConstrain Proportions\u201d is enabled for the layer\u2019s scale property and both dimensions are set to the same value.\n",
    offerBeta: false,
    offerTrial: true,
    privateNumber: 8139366561381304,
    productSKU: "MMTBP-SUL",
    scriptAuthor: "Motion Methods",
    scriptName: "BorderPatrol",
    scriptURL: "https://aescripts.com/borderpatrol",
    scriptVersion: "1.0.3",
  };
  function a(vars) {
    function licUI() {
    ...
    var maxUIButtons = 3;
    var licV = 2;
    var mx = __BLOB__BLOB_000010__;
    var wx = __BLOB__BLOB_000011__;
  ...
  var k4 = new a(k4_settings);
  if (k4.c()) {
    function getSelectedLayers() {
      k4.s();
      try {
        var curItem = app.project.activeItem;
        var selectedShapeLayers = [];
        if (curItem && curItem instanceof CompItem) {
          var numLayers = curItem.selectedLayers.length;
          onlyShapeLayers = true;
          if (numLayers > 0) {
            if (isTrial && numLayers > trialLayerLimit) {
              ...
              alert(
                "Trial Version\nThere\'s a " +
                  trialLayerLimit +
                  " layer maximum. Only the first " +
                  trialLayerLimit +
                  " selected shape layers will be modified.",
              );
            }
            for (var i = 0; i < numLayers; i += 1) {
              curLayer = curItem.selectedLayers[i];
              if (curLayer.matchName == "ADBE Vector Layer") {
                selectedShapeLayers.push(curLayer);
              } else {
                onlyShapeLayers = false;
              }
            }
            if (!onlyShapeLayers) {
              alert("Oops\rBe sure to only select shape layers.");
            } else {
              if (selectedShapeLayers.length < 1) {
                alert("Oops\rSelect some a shape layer(s) first.");
              }
            }
            return selectedShapeLayers;
          } else {
            alert("Oops\rSelect some shape layer(s) first.");
          }
        } else {
          alert(
            "Do this stuff first\r1. Open a comp.\r2. Select some shape layer(s).",
          );
        }
      } catch (err) {
    ...
    function repoCornerShapeLayer(shapeLayer, newCorner) {
      try {
        var comp = app.project.activeItem;
        curLayer = shapeLayer;
        maintainStrokeWidth(shapeLayer);
        var getCornersExp =
          '\n                        \n                        var rect = thisLayer.sourceRectAtTime(time, false);\n                                            \n                        var shapePos = thisLayer("ADBE Root Vectors Group")(1)("ADBE Vector Transform Group")("ADBE Vector Position");\n                        var offsetX = shapePos[0] - rect.width/2;\n                        var offsetY = shapePos[1] - rect.height/2;\n                        \n                        var topLeft = thisLayer.toWorld([0+offsetX, 0+offsetY]);\n                        var topRight = thisLayer.toWorld([rect.width+offsetX, 0+offsetY]);\n                        var bottomLeft = thisLayer.toWorld([0+offsetX, rect.height+offsetY]);\n                        var bottomRight = thisLayer.toWorld([rect.width+offsetX, rect.height+offsetY]);\n                        \n                        var topCenter = [(topLeft[0]+topRight[0])/2, (topLeft[1]+topRight[1])/2];\n                        var middleLeft = [(topLeft[0]+bottomLeft[0])/2, (topLeft[1]+bottomLeft[1])/2];\n                        var middleRight = [(topRight[0]+bottomRight[0])/2, (topRight[1]+bottomRight[1])/2];\n                        var bottomCenter = [(bottomLeft[0]+bottomRight[0])/2, (bottomLeft[1]+bottomRight[1])/2];\n                        var middleCenter = [(middleLeft[0]+middleRight[0])/2, (middleLeft[1]+middleRight[1])/2];\n                        ';
        var cornerExpArray = new Array(
          "topLeft",
          "topCenter",
          "topRight",
          "middleLeft",
        ...
        var cornerValArray = [];
        for (var i = 0; i < cornerExpArray.length; i += 1) {
          finalExp = "";
          finalExp = getCornersExp + cornerExpArray[i];
          curLayer
            .property("ADBE Effect Parade")
            .addProperty("ADBE Point3D Control");
          effectIndex = curLayer.property("ADBE Effect Parade").numProperties;
          pointControlEffect = curLayer
            .property("ADBE Effect Parade")
            .property(effectIndex)
            .property("ADBE Point3D Control-0001");
          pointControlEffect.expression = finalExp;
          cornerVal = pointControlEffect.value.toString().split(",");
          cornerValArray.push(cornerVal);
          curLayer
            .property("ADBE Effect Parade")
            .property(effectIndex)
            .remove();
        }
        var topLeft = cornerValArray[0];
        var topCenter = cornerValArray[1];
        var topRight = cornerValArray[2];
        var middleLeft = cornerValArray[3];
        var middleCenter = cornerValArray[4];
        var middleRight = cornerValArray[5];
        var bottomLeft = cornerValArray[6];
        var bottomCenter = cornerValArray[7];
        var bottomRight = cornerValArray[8];
        var rect = curLayer.sourceRectAtTime(comp.time, false);
        var halfWidth = rect.width / 2;
        var halfHeight = rect.height / 2;
        var layerAncProp = curLayer
          .property("ADBE Transform Group")
          .property("ADBE Anchor Point");
        var layerAncValue = layerAncProp.valueAtTime(comp.time, false);
        var ancX = layerAncValue[0];
        var ancY = layerAncValue[1];
        switch (newCorner) {
          case "topLeft":
            ancX -= halfWidth;
            ancY -= halfHeight;
          ...
          case "middleLeft":
            ancX -= halfWidth;
            newLocation = middleLeft;
            break;
          case "middleCenter":
            newLocation = middleCenter;
            break;
          case "middleRight":
            ancX += halfWidth;
            newLocation = middleRight;
            break;
          case "bottomLeft":
            ancX -= halfWidth;
            ancY += halfHeight;
        ...
        if (curLayer.parent != null) {
          var curParentIndex = curLayer.parent.index;
          curLayer.parent = null;
        }
        var layerPosProp = curLayer
          .property("ADBE Transform Group")
          .property("ADBE Position");
        var positionSeprated = layerPosProp.dimensionsSeparated;
        if (positionSeprated) {
          layerPosProp.dimensionsSeparated = false;
        }
        if (layerAncProp.numKeys > 0) {
          layerAncProp.setValueAtTime(comp.time, [ancX, ancY]);
        } else {
          layerAncProp.setValue([ancX, ancY]);
        }
        if (layerPosProp.numKeys > 0) {
          layerPosProp.setValueAtTime(comp.time, [
            newLocation[0],
            newLocation[1],
          ]);
        } else {
          layerPosProp.setValue([newLocation[0], newLocation[1]]);
        }
        if (positionSeprated) {
          layerPosProp.dimensionsSeparated = true;
        }
        if (curLayer.parent == null && curParentIndex != undefined) {
          curLayer.parent = comp.layer(curParentIndex);
        }
      } catch (err) {
        alert("Error at line " + err.line.toString() + "\r" + err.toString());
      }
    ...
    function groupShapes() {
      ...
      var numSelectedLayers = mySelectedLayers.length;
      var selectedIndex = [];
      for (var i = 0; i < numSelectedLayers; i += 1) {
        mySelectedLayers[i].selected = false;
        selectedIndex[i] = mySelectedLayers[i].index;
      }
      for (var i = 0; i < numSelectedLayers; i += 1) {
        var myContents = myComp
        ...
        myComp.layer(selectedIndex[i]).selected = false;
      }
      for (var i = 0; i < numSelectedLayers; i += 1) {
    ...
    function maintainStrokeWidth(propGroup) {
      try {
        var rectSizeExp =
          "var _0x13f6=[\'abs\',\'ADBE Transform Group\',\'ADBE Scale\'];var _0xdf91=function(_0x152955,_0x49d479){_0x152955=_0x152955-0x0;var _0x54bfa2=_0x13f6[_0x152955];return _0x54bfa2;};var _0x2b97e9=Math[_0xdf91(\'0x0\')](thisLayer(_0xdf91(\'0x1\'))(_0xdf91(\'0x2\'))[0x0]);var _0xf525cd=Math[_0xdf91(\'0x0\')](thisLayer(_0xdf91(\'0x1\'))(_0xdf91(\'0x2\'))[0x1]);[value[0x0]*(_0x2b97e9/0x64),value[0x1]*(_0xf525cd/0x64)];";
        var rectStrokeWidthExp =
          "var _0x45b3=[\'propertyGroup\',\'ADBE Vector Rect Size\'];(function(_0x31dd2a,_0x371f44){var _0x464d20=function(_0x2d4c73){while(--_0x2d4c73){_0x31dd2a[\'push\'](_0x31dd2a[\'shift\']());}};_0x464d20(++_0x371f44);}(_0x45b3,0x1ce));var _0x1f15=function(_0x247326,_0x504b97){_0x247326=_0x247326-0x0;var _0x1c35cb=_0x45b3[_0x247326];return _0x1c35cb;};var strokeW=value;var curShape=thisProperty[_0x1f15(\'0x0\')](0x1)[_0x1f15(\'0x0\')](0x1)[_0x1f15(\'0x0\')](0x1);var shapeSizeX=curShape(\'ADBE Vectors Group\')(0x1)(_0x1f15(\'0x1\'))[0x0];var shapeSizeY=curShape(\'ADBE Vectors Group\')(0x1)(_0x1f15(\'0x1\'))[0x1];if(shapeSizeX<=strokeW&&shapeSizeX<=shapeSizeY){strokeW=shapeSizeX;}else if(shapeSizeY<=strokeW&&shapeSizeY<=shapeSizeX){strokeW=shapeSizeY;}else{strokeW;}";
        var rectScaleExp =
          "var _0xfe52=[\'ADBE Transform Group\',\'ADBE Scale\',\'abs\'];var _0x68d6=function(_0x22f713,_0x7a951f){_0x22f713=_0x22f713-0x0;var _0x259bae=_0xfe52[_0x22f713];return _0x259bae;};var _0xc6057e=Math[\'abs\'](thisLayer(_0x68d6(\'0x0\'))(_0x68d6(\'0x1\'))[0x0]);var _0x14b59e=Math[_0x68d6(\'0x2\')](thisLayer(_0x68d6(\'0x0\'))(_0x68d6(\'0x1\'))[0x1]);if(_0xc6057e>0x0&&_0x14b59e>0x0){[value[0x0]/_0xc6057e*0x64,value[0x1]/_0x14b59e*0x64];}else{[0x0,0x0];}";
        var ellipseSizeExp =
          "var _0x7084=[\'abs\',\'ADBE Transform Group\',\'ADBE Scale\'];var _0x2eff=function(_0x4ea91e,_0x189a79){_0x4ea91e=_0x4ea91e-0x0;var _0x3f253d=_0x7084[_0x4ea91e];return _0x3f253d;};var _0x3c89f9=Math[_0x2eff(\'0x0\')](thisLayer(_0x2eff(\'0x1\'))(_0x2eff(\'0x2\'))[0x0]);var _0x9efd0a=Math[_0x2eff(\'0x0\')](thisLayer(_0x2eff(\'0x1\'))(\'ADBE Scale\')[0x1]);[value[0x0]*(_0x3c89f9/0x64),value[0x1]*(_0x9efd0a/0x64)];";
        var ellipseStrokeWidthExp =
          "var _0x24c9=[\'ADBE Vector Ellipse Size\',\'propertyGroup\',\'ADBE Vectors Group\'];(function(_0x588aa0,_0x4b33db){var _0x1214c3=function(_0x153f2d){while(--_0x153f2d){_0x588aa0[\'push\'](_0x588aa0[\'shift\']());}};_0x1214c3(++_0x4b33db);}(_0x24c9,0x1ae));var _0x27cf=function(_0x41d6d3,_0x509296){_0x41d6d3=_0x41d6d3-0x0;var _0x2c5eba=_0x24c9[_0x41d6d3];return _0x2c5eba;};var strokeW=value;var curShape=thisProperty[_0x27cf(\'0x0\')](0x1)[_0x27cf(\'0x0\')](0x1)[_0x27cf(\'0x0\')](0x1);var shapeSizeX=curShape(_0x27cf(\'0x1\'))(0x1)(_0x27cf(\'0x2\'))[0x0];var shapeSizeY=curShape(_0x27cf(\'0x1\'))(0x1)(\'ADBE Vector Ellipse Size\')[0x1];if(shapeSizeX<=strokeW&&shapeSizeX<=shapeSizeY){strokeW=shapeSizeX;}else if(shapeSizeY<=strokeW&&shapeSizeY<=shapeSizeX){strokeW=shapeSizeY;}strokeW;";
        var ellipseScaleExp =
          "var _0x82bd=[\'ADBE Transform Group\',\'abs\',\'ADBE Scale\'];var _0x29df=function(_0x45f04a,_0x5001ed){_0x45f04a=_0x45f04a-0x0;var _0x5ba0f1=_0x82bd[_0x45f04a];return _0x5ba0f1;};var _0x4baee0=Math[\'abs\'](thisLayer(_0x29df(\'0x0\'))(\'ADBE Scale\')[0x0]);var _0x4ea3bc=Math[_0x29df(\'0x1\')](thisLayer(\'ADBE Transform Group\')(_0x29df(\'0x2\'))[0x1]);if(_0x4baee0>0x0&&_0x4ea3bc>0x0){[value[0x0]/_0x4baee0*0x64,value[0x1]/_0x4ea3bc*0x64];}else{[0x0,0x0];}";
        var starOutRadiusExp =
          "var _0x1b45=[\'abs\',\'ADBE Transform Group\',\'ADBE Scale\'];var _0x8066=function(_0x562b86,_0x28b4ea){_0x562b86=_0x562b86-0x0;var _0x5d7d10=_0x1b45[_0x562b86];return _0x5d7d10;};var _0x381cfe=Math[_0x8066(\'0x0\')](thisLayer(_0x8066(\'0x1\'))(_0x8066(\'0x2\'))[0x0]);value*(_0x381cfe/0x64);";
        var starInRadiusExp = starOutRadiusExp;
        var starStrokeWidthExp =
          "var _0x89d8=[\'ADBE Vectors Group\',\'ADBE Vector Star Outer Radius\',\'propertyGroup\'];(function(_0x4f4088,_0x1bcfc7){var _0x29101c=function(_0x43ebed){while(--_0x43ebed){_0x4f4088[\'push\'](_0x4f4088[\'shift\']());}};_0x29101c(++_0x1bcfc7);}(_0x89d8,0x104));var _0x24d3=function(_0x4cab6a,_0x502bd8){_0x4cab6a=_0x4cab6a-0x0;var _0x5d6daf=_0x89d8[_0x4cab6a];return _0x5d6daf;};var strokeW=value;var curShape=thisProperty[_0x24d3(\'0x0\')](0x1)[_0x24d3(\'0x0\')](0x1)[_0x24d3(\'0x0\')](0x1);var r=curShape(_0x24d3(\'0x1\'))(0x1)(_0x24d3(\'0x2\'));if(r<=strokeW/0x2){strokeW=0x2*r;}strokeW;";
        var starScaleExp =
          "var _0x1fee=[\'abs\',\'ADBE Scale\'];var _0x1716=function(_0x4e752a,_0x211c8c){_0x4e752a=_0x4e752a-0x0;var _0x15c384=_0x1fee[_0x4e752a];return _0x15c384;};var _0x4d7c9c=Math[_0x1716(\'0x0\')](thisLayer(\'ADBE Transform Group\')(_0x1716(\'0x1\'))[0x0]);var _0x2c99c8=Math[_0x1716(\'0x0\')](thisLayer(\'ADBE Transform Group\')(_0x1716(\'0x1\'))[0x1]);if(_0x4d7c9c>0x0&&_0x2c99c8>0x0){[value[0x0]/_0x4d7c9c*0x64,value[0x1]/_0x2c99c8*0x64];}else{[0x0,0x0];}";
        var bezierPathExp =
          "var _0x4c43=[\'scale\',\'points\',\'inTangents\',\'outTangents\',\'isClosed\',\'length\'];var _0x4446=function(_0x3793ca,_0x4518b7){_0x3793ca=_0x3793ca-0x0;var _0x4e8cf2=_0x4c43[_0x3793ca];return _0x4e8cf2;};var _0x4ed38d=transform[\'scale\'][0x0]/0x64;var _0x33a893=transform[_0x4446(\'0x0\')][0x1]/0x64;var _0x36ba36=thisProperty[_0x4446(\'0x1\')]();var _0x165156=thisProperty[_0x4446(\'0x2\')]();var _0x8678d4=thisProperty[_0x4446(\'0x3\')]();var _0x4df608=thisProperty[_0x4446(\'0x4\')]();for(var _0x1ec861=0x0;_0x1ec861<_0x36ba36[_0x4446(\'0x5\')];_0x1ec861++){_0x36ba36[_0x1ec861][0x0]=_0x36ba36[_0x1ec861][0x0]*_0x4ed38d;_0x165156[_0x1ec861][0x0]=_0x165156[_0x1ec861][0x0]*_0x4ed38d;_0x8678d4[_0x1ec861][0x0]=_0x8678d4[_0x1ec861][0x0]*_0x4ed38d;_0x36ba36[_0x1ec861][0x1]=_0x36ba36[_0x1ec861][0x1]*_0x33a893;_0x165156[_0x1ec861][0x1]=_0x165156[_0x1ec861][0x1]*_0x33a893;_0x8678d4[_0x1ec861][0x1]=_0x8678d4[_0x1ec861][0x1]*_0x33a893;}createPath(_0x36ba36,_0x165156,_0x8678d4,_0x4df608);";
        var bezierStrokeWidthExp =
          "var _0x4413=[\'scale\',\'min\',\'abs\',\'sourceRectAtTime\',\'height\'];var _0x57cf=function(_0x2c5904,_0x45b4d0){_0x2c5904=_0x2c5904-0x0;var _0x4725a3=_0x4413[_0x2c5904];return _0x4725a3;};var _0x158c17=value;var _0x1f97fd=transform[_0x57cf(\'0x0\')][0x0];var _0x4724d3=transform[_0x57cf(\'0x0\')][0x1];var _0x20af8f=Math[_0x57cf(\'0x1\')](Math[_0x57cf(\'0x2\')](_0x1f97fd),Math[_0x57cf(\'0x2\')](_0x4724d3));var _0x501ec0=thisLayer;var _0x4d3105=_0x501ec0[_0x57cf(\'0x3\')](time);var _0x47278a=_0x4d3105[\'width\']*_0x20af8f/0x64;var _0xfad3f7=_0x4d3105[_0x57cf(\'0x4\')]*_0x20af8f/0x64;var _0x4daf7d=Math[_0x57cf(\'0x1\')](_0x47278a,_0xfad3f7);if(_0x4daf7d<_0x158c17&&_0x20af8f!=0x0){_0x158c17=_0x4daf7d;}else if(_0x20af8f==0x0){_0x158c17=value;}_0x158c17;";
        var bezierScaleExp =
          "var _0x17ba=[\'scale\'];var _0x30a4=function(_0x119d9f,_0x2b8c13){_0x119d9f=_0x119d9f-0x0;var _0x195dc5=_0x17ba[_0x119d9f];return _0x195dc5;};var _0x9d6dd0=transform[_0x30a4(\'0x0\')][0x0];var _0x54fac1=transform[_0x30a4(\'0x0\')][0x1];if(_0x9d6dd0==0x0){_0x9d6dd0=0.001;}if(_0x54fac1==0x0){_0x54fac1=0.001;}[value[0x0]/_0x9d6dd0*0x64,value[0x1]/_0x54fac1*0x64];";
        var bezierLayerScaleExp =
          "var _0x2e18b9=value[0x0];var _0x4ba1a4=value[0x1];if(_0x2e18b9==0x0){_0x2e18b9=0.1;}if(_0x4ba1a4==0x0){_0x4ba1a4=0.1;}[_0x2e18b9,_0x4ba1a4];";
        for (var i = 1; i <= propGroup.numProperties; i += 1) {
          prop = propGroup.property(i);
          if (prop.propertyType === PropertyType.PROPERTY) {
            if (propGroup.matchName === "ADBE Vector Group") {
              curProp = propGroup.property("ADBE Vectors Group");
              if (curProp.hasOwnProperty("ADBE Vector Shape - Rect")) {
                for (var i = 1; i <= curProp.numProperties; i += 1) {
                  curProp
                    .property("ADBE Vector Shape - Rect")
                    .property("ADBE Vector Rect Size").expression = rectSizeExp;
                  propGroup
                    .property("ADBE Vector Transform Group")
                    .property("ADBE Vector Scale").expression = rectScaleExp;
                  if (
                    curProp.property(i).matchName ===
                    ...
                    if (checkBoxVal === true) {
                      curProp
                        .property(i)
                        .property("ADBE Vector Stroke Width").expression =
                        rectStrokeWidthExp;
                    } else {
                      curProp
                        .property(i)
              ...
              if (curProp.hasOwnProperty("ADBE Vector Shape - Ellipse")) {
                for (var i = 1; i <= curProp.numProperties; i += 1) {
                  curProp
                    .property("ADBE Vector Shape - Ellipse")
                    .property("ADBE Vector Ellipse Size").expression =
                    ellipseSizeExp;
                  propGroup
                    .property("ADBE Vector Transform Group")
                    .property("ADBE Vector Scale").expression = ellipseScaleExp;
                  if (
                    curProp.property(i).matchName ===
                      "ADBE Vector Graphic - Stroke" ||
                    curProp.property(i).matchName ===
              ...
              if (curProp.hasOwnProperty("ADBE Vector Shape - Star")) {
                for (var i = 1; i <= curProp.numProperties; i += 1) {
                  curProp
                    .property("ADBE Vector Shape - Star")
                    .property("ADBE Vector Star Outer Radius").expression =
                    starOutRadiusExp;
                  if (
                    curProp
                      .property("ADBE Vector Shape - Star")
                      .property("ADBE Vector Star Type").value === 1
                  ) {
                    curProp
                      .property("ADBE Vector Shape - Star")
                      .property("ADBE Vector Star Inner Radius").expression =
                      starInRadiusExp;
                  }
                  propGroup
                    .property("ADBE Vector Transform Group")
                    .property("ADBE Vector Scale").expression = starScaleExp;
                  if (
                    curProp.property(i).matchName ===
                      "ADBE Vector Graphic - Stroke" ||
                    curProp.property(i).matchName ===
              ...
              if (curProp.hasOwnProperty("ADBE Vector Shape - Group")) {
                for (var i = 1; i <= curProp.numProperties; i += 1) {
                  curProp
                    .property("ADBE Vector Shape - Group")
                    .property("ADBE Vector Shape").expression = bezierPathExp;
                  propGroup
                    .property("ADBE Vector Transform Group")
                    .property("ADBE Vector Scale").expression = bezierScaleExp;
                  if (
                    curProp.property(i).matchName ===
                      "ADBE Vector Graphic - Stroke" ||
                    curProp.property(i).matchName ===
            ...
            if (
              ...
              maintainStrokeWidth(prop);
            }
          }
        }
        if (propGroup.matchName === "ADBE Transform Group") {
          curProp = propGroup.property("ADBE Scale");
          if (checkBoxVal === true) {
            curProp.expression = "";
          } else {
            curProp.expression = bezierLayerScaleExp;
          }
        }
      } catch (err) {
        alert("Error at line " + err.line.toString() + "\r" + err.toString());
    ...
    function myScript_buildUI(thisObj) {
      ...
      var res_UI =
        "group{orientation:\'column\', alignment:[\'left\', \'top\']\n                        panelOne: Panel{text:\'Maintain Stroke: \', orientation:\'column\', alignment:[\'fill\', \'fill\'],  margins:[10,15,10,22]\n                            grp0: Group{orientation:\'column\', alignment:[\'center\', \'top\'], alignChildren:[\'fill\', \'fill\'], margins:[0,0,0,-10]\n                                grp1: Group{orientation:\'row\', alignment:[\'center\', \'top\'], alignChildren:[\'fill\', \'fill\'], spacing: [-10,-10,-10,-10]\n                                    topLeftBtnUI: Button{text:\'\u250f\', preferredSize:[28,28]},\n                                    topCenterBtnUI: Button{text:\'\u2533\', preferredSize:[28,28]},\n                                    topRightBtnUI: Button{text:\'\u2513\', preferredSize:[28,28]},\n                                },\n                                grp2: Group{orientation:\'row\', alignment:[\'center\', \'top\'], alignChildren:[\'fill\', \'fill\'], margins:[-10,-10,-10,-10], spacing: [-10,-10,-10,-10]\n                                    middleLeftBtnUI: Button{text:\'\u2523\', preferredSize:[28,28]},\n                                    centerBtnUI: Button{text:\'\u254b\', preferredSize:[28,28]},\n                                    middleRightBtnUI: Button{text:\'\u252b\', preferredSize:[28,28]},\n                                },\n                                grp3: Group{orientation:\'row\', alignment:[\'center\', \'top\'], alignChildren:[\'fill\', \'fill\'], margins:[-10,-10,-10,-10], spacing: [-10,-10,-10,-10]\n                                    bottomLeftBtnUI: Button{text:\'\u2517\', preferredSize:[28,28]},\n                                    bottomCenterBtnUI: Button{text:\'\u253b\', preferredSize:[28,28]},\n                                    bottomRightBtnUI: Button{text:\'\u251b\', preferredSize:[28,28]},\n                                },\n                                grp4: Group{orientation:\'column\', alignment:[\'center\', \'top\'], alignChildren:[\'fill\', \'fill\'], margins:[-10,0,-10,0], spacing: [-10,-10,-10,-10]\n                                    maintainStrokeBtnUI: Button{text:\'Leave Anchor\', preferredSize:[84,28]},\n                                },\n                            },\n                        },\n                        panelTwo: Panel{text:\'Option:\', orientation:\'column\', alignment:[\'fill\', \'fill\'], margins:[10,15,10,10]\n                            grp1: Group{orientation:\'column\', alignChildren:[\'fill\', \'top\'], alignment:[\'fill\', \'fill\']\n                                collapseCheckboxUI: Checkbox{text:\'Collapse Stroke\', preferredSize:[-1,15]},\n                            },\n                        },\n                        aboutBtnUI: Button{text:\'?\', preferredSize:[20,20], alignment:[\'right\', \'top\']},\n                    }";
      myPanel.grp = myPanel.add(res_UI);
      var pnl1 = myPanel.grp.panelOne.grp0;
      var pnl2 = myPanel.grp.panelTwo;
      var topLeftBtn = pnl1.grp1.topLeftBtnUI;
      var topCenterBtn = pnl1.grp1.topCenterBtnUI;
      var topRightBtn = pnl1.grp1.topRightBtnUI;
      var middleLeftBtn = pnl1.grp2.middleLeftBtnUI;
      var centerBtn = pnl1.grp2.centerBtnUI;
      var middleRightBtn = pnl1.grp2.middleRightBtnUI;
      var bottomLeftBtn = pnl1.grp3.bottomLeftBtnUI;
      var bottomCenterBtn = pnl1.grp3.bottomCenterBtnUI;
      var bottomRightBtn = pnl1.grp3.bottomRightBtnUI;
      var aboutBtn = myPanel.grp.aboutBtnUI;
      var maintainStrokeBtn = pnl1.grp4.maintainStrokeBtnUI;
      collapseCheckbox = pnl2.grp1.collapseCheckboxUI;
      collapseCheckbox.value = checkBoxVal;
      collapseCheckbox.helpTip =
        "Stroke width scales when shape size\nis smaller than stroke width.";
      collapseCheckbox.onClick = function () {
        if (checkBoxVal === true) {
          checkBoxVal = false;
        } else {
          checkBoxVal = true;
      ...
      borderControlBtnOptimized = function (newCorner) {
        app.beginUndoGroup(scriptName);
        var selectedShapeLayers = getSelectedLayers();
        if (onlyShapeLayers) {
          groupShapes();
          app.executeCommand(10312);
          for (var i = 0; i < selectedShapeLayers.length; i += 1) {
            repoCornerShapeLayer(selectedShapeLayers[i], newCorner);
          }
          ungroupShapes();
        }
        app.endUndoGroup();
      ...
      topLeftBtn.onClick = function () {
        borderControlBtnOptimized("topLeft");
      };
      topLeftBtn.helpTip =
        "Maintain stroke width and move \nanchor point to top-left.";
      topCenterBtn.onClick = function () {
        borderControlBtnOptimized("topCenter");
      };
      topCenterBtn.helpTip =
        "Maintain stroke width and move \nanchor point to top-center.";
      topRightBtn.onClick = function () {
        borderControlBtnOptimized("topRight");
      };
      topRightBtn.helpTip =
        "Maintain stroke width and move \nanchor point to top-right.";
      middleLeftBtn.onClick = function () {
        borderControlBtnOptimized("middleLeft");
      };
      middleLeftBtn.helpTip =
        "Maintain stroke width and move \nanchor point to middle-left.";
      centerBtn.onClick = function () {
        ...
        if (onlyShapeLayers) {
          app.executeCommand(10312);
          for (var i = 0; i < selectedShapeLayers.length; i += 1) {
            maintainStrokeWidth(selectedShapeLayers[i]);
          }
        }
        app.endUndoGroup();
      };
      ...
      middleRightBtn.onClick = function () {
        borderControlBtnOptimized("middleRight");
      };
      middleRightBtn.helpTip =
        "Maintain stroke width and move \nanchor point to middle-right.";
      bottomLeftBtn.onClick = function () {
        borderControlBtnOptimized("bottomLeft");
      };
      bottomLeftBtn.helpTip =
        "Maintain stroke width and move \nanchor point to bottom-left.";
      bottomCenterBtn.onClick = function () {
        borderControlBtnOptimized("bottomCenter");
      };
      bottomCenterBtn.helpTip =
        "Maintain stroke width and move \nanchor point to bottom-center.";
      bottomRightBtn.onClick = function () {
        borderControlBtnOptimized("bottomRight");
      };
      bottomRightBtn.helpTip =
        "Maintain stroke width and move \nanchor point to bottom-right.";
      maintainStrokeBtn.onClick = function () {
        app.beginUndoGroup(scriptName);
        var selectedShapeLayers = getSelectedLayers();
        if (onlyShapeLayers) {
          for (var i = 0; i < selectedShapeLayers.length; i += 1) {
      ...
      maintainStrokeBtn.helpTip =
        "Maintain stroke width without\nrepositioning the anchor point.";
    ...
    openURL = function (url) {
      if (
        ...
        var aeVersionString = app.version.slice(0, 4);
        var aeVersionNum = eval(aeVersionString);
        if (aeVersionNum >= 16.1) {
          alert(
