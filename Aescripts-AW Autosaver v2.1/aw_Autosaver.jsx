...
function awasv2lcn() {
  var af_settings = {
    ...
    betaSupportEmail: "support@motion.land",
    helpButtons: [],
    helpText: "This is the help docs. Use \n for new lines",
    offerBeta: false,
    offerTrial: true,
    privateNumber: 746620,
    productSKU: "AWAS2-SUL",
    scriptAuthor: "Alex White",
    scriptName: "aw_Autosaver",
    scriptURL: "http://aescripts.com/aw-autosaver/",
    scriptVersion: "2.1",
  };
  function a(vars) {
    function licUI() {
    ...
    var maxUIButtons = 3;
    var licV = 2;
    var mx = __BLOB__BLOB_000565__;
    var wx = __BLOB__BLOB_000566__;
  ...
  if (awasxwt.c()) {
    awasxwt = new a(af_settings);
    var isTrial = awasxwt.vt() ? true : true;
    return isTrial;
  }
}
if (awasv2lcn()) {
  function awautosaver(thisObj) {
    function helpTips() {
      autoSaverPanel.manSave.helpTip =
        "-Save original project and it`s copy\n-\'\'Shift+Click\'\' will save only project copy\n-\'\'Ctrl+Click\'\' to add comment to current project version";
      autoSaverPanel.chkBox.helpTip = "Switch autosave On/Off";
      autoSaverPanel.pathBt.helpTip =
        "Choose path\nwhere copy of your project will be saved";
      pathIcon.helpTip =
        "-Click to reveal project path in explorer or finder\n-or \'\'Shift+click\'\' to open copy`s folder";
      pathGroup.settings.helpTip = "-Open Settings/About";
      if (app.settings.haveSetting("awautosaverV2", "helpTips")) {
        getHelpTips = app.settings.getSetting("awautosaverV2", "helpTips");
        if (getHelpTips == "true") {
          autoSaverPanel.manSave.helpTip = "";
          autoSaverPanel.chkBox.helpTip = "";
          autoSaverPanel.pathBt.helpTip = "";
          pathIcon.helpTip = "";
          pathGroup.settings.helpTip = "";
        }
      }
    }
    function about() {
      ...
      function VersionsFolder() {
        versionsfolder = settings.createVersions.value;
        app.settings.saveSetting(
          "awautosaverV2",
          "versionsFolder",
          versionsfolder,
        );
        createVersionsFolder = app.settings.getSetting(
          "awautosaverV2",
          "versionsFolder",
        );
      }
      function CopVersionsFunct() {
        copyvers = settings.copyVersionsFolder.value;
        app.settings.saveSetting(
          "awautosaverV2",
          "copyVersionsFolder",
          copyvers,
        );
        CopyVersions = app.settings.getSetting(
          "awautosaverV2",
          "copyVersionsFolder",
        );
      }
      function toggleTips() {
        tips = settings.toggleHelpTips.value;
        app.settings.saveSetting("awautosaverV2", "helpTips", tips);
        helpTips();
        return;
      }
      function IndividualFoldersFunct() {
        folder11 = settings.individualFolder.value;
        app.settings.saveSetting("awautosaverV2", "indivfolders", folder11);
        IndividualFolders = app.settings.getSetting(
          "awautosaverV2",
          "indivfolders",
        );
      }
      setPan2 = new Window("palette", "About | Settings", undefined);
      setPan2.orientation = "column";
      var myBinary1 = [__BLOB__BLOB_000567__];
      icons_1 = new File(AWAS.userDataFolder.toString() + "/xxxmyFile1xxx.png");
      icons_1.encoding = "BINARY";
      icons_1.open("w");
      icons_1.write(myBinary1);
      icons_1.close();
      var myBinary2 = [__BLOB__BLOB_000568__];
      icons_2 = new File(AWAS.userDataFolder.toString() + "/xxxmyFile2xxx.png");
      icons_2.encoding = "BINARY";
      icons_2.open("w");
      icons_2.write(myBinary2);
      icons_2.close();
      var myBinary = [__BLOB__BLOB_000569__];
      var infoStuff = setPan2.add("group", undefined, "infoStuff");
      infoStuff.alignment = "left";
      infoStuff.spacing = 30;
      var scriptVersion = infoStuff.add(
        "statictext",
        undefined,
        "aw_Autosaver v 2.1",
      );
      var vimeoButton = infoStuff.add("button", undefined, "Video tutorial");
      vimeoButton.helpTip = "https://vimeo.com/spylabs/awautosaver2";
      var updatesButton = infoStuff.add("button", undefined, "Check updates");
      updatesButton.helpTip = "http://aescripts.com/aw-autosaver2/";
      var emailButton = infoStuff.add("button", undefined, "Email me");
      emailButton.helpTip = "support@spylabs.org";
      var registrationInfo = setPan2.add(
        "statictext",
        undefined,
        awasv2lcn("p"),
      );
      var tabbPanel = setPan2.add("group", undefined, "Tabs");
      var tPanel = tabbPanel.add("tabbedpanel");
      tPanel.alignChildren = ["fill", "fill"];
      tPanel.preferredSize = [500, 300];
      var settings = tPanel.add("tab", undefined, "Settings");
      settings.alignChildren = ["left", "top"];
      settings.spacing = 15;
      settings.margins = 30;
      settings.individualFolder = settings.add(
        "checkbox",
        undefined,
        "Save copies in individual folders",
      );
      settings.individualFolder.helpTip =
        "Will create and save in folder same as your project name in path you choosed.\nEXAMPLE: ~/Dropbox/Particles/Particles.aep";
      settings.createVersions = settings.add(
        "checkbox",
        undefined,
        "Create versions folder",
      );
      settings.createVersions.helpTip =
        "Will create folder and save there project versions .\nEXAMPLE: ~/Dropbox/Particles(versions folder)/Particles version_1.aep";
      var versionsGroup = settings.add("group", undefined, "versionsGroup");
      versionsGroup.maxVersionsNum = versionsGroup.add(
        "edittext",
        undefined,
        "3",
      );
      Versions = "3";
      versionsGroup.maxVersionsText = versionsGroup.add(
        "statictext",
        undefined,
        "Maximum project versions",
      );
      versionsGroup.maxVersionsNum.size = [40, 20];
      settings.copyVersionsFolder = settings.add(
        "checkbox",
        undefined,
        "Create copy of versions folder",
      );
      settings.copyVersionsFolder.helpTip =
        "Will copy (project versions) folder to chosen path.";
      settings.toggleHelpTips = settings.add(
        "checkbox",
        undefined,
        "Turn help tips off",
      );
      var radioGroup_1 = settings.add("group", undefined, "Radio1");
      var radioGroup_2 = settings.add("group", undefined, "Radio2");
      var UI1 = radioGroup_1.add("radiobutton", undefined, "");
      UI1.value = true;
      var UI2 = radioGroup_2.add("radiobutton", undefined, "");
      radioGroup_1.icons_1 = radioGroup_1.add("image", undefined, icons_1);
      radioGroup_2.icons_2 = radioGroup_2.add("image", undefined, icons_2);
      aboutTab = tPanel.add("tab", undefined, "About");
      aboutTab.alighChildren = ["left", "top"];
      aboutTab.margins = 20;
      var aboutText = aboutTab.add(
        "statictext",
        undefined,
        "aw_Autosaver v2.1 \n\nHover on any elemnt to get description what it does. \n\n\n Changelog:\n\n - 2.0 Initial Release. \n- 2.1 Minor fixes, Updated licensing framework. \n",
        {
          borderless: true,
          multiline: true,
          readonly: true,
      ...
      aboutText.alignment = "left";
      icons_1.remove();
      icons_2.remove();
      if (app.settings.haveSetting("awautosaverV2", "UI1")) {
        UIswitch = app.settings.getSetting("awautosaverV2", "UI1");
        if (eval(UIswitch) == true) {
          UI1.value = true;
          UI2.value = false;
        } else {
          UI1.value = false;
      ...
      app.settings.haveSetting("awautosaverV2", "version")
        ? (Versions = app.settings.getSetting("awautosaverV2", "version"))
        : app.settings.saveSetting("awautosaverV2", "version", Versions);
      versionsGroup.maxVersionsNum.text = Versions;
      if (app.settings.haveSetting("awautosaverV2", "helpTips")) {
        getHelpTips = app.settings.getSetting("awautosaverV2", "helpTips");
        getHelpTips == "false" ? (tips = false) : (tips = true);
      } else {
        tips = false;
      }
      settings.toggleHelpTips.value = tips;
      settings.toggleHelpTips.onClick = toggleTips;
      versionsGroup.maxVersionsNum.onChange = function () {
        num = versionsGroup.maxVersionsNum.text;
        if (isNaN(num)) {
          alert("Please, input number");
        } else if (num < 3) {
          alert("Minimum number of versions = 3");
          ver = 3;
          versionsGroup.maxVersionsNum.text = "3";
          app.settings.saveSetting("awautosaverV2", "version", ver);
        } else {
          if (num > 10 && awasv2lcn("v").match(/^t/)) {
            alert("Sorry, in trial mode you can save only 10 versions");
            ver = 10;
          } else {
            ver = num;
          }
      ...
      if (app.settings.haveSetting("awautosaverV2", "indivfolders")) {
        IndividualFolders = app.settings.getSetting(
          "awautosaverV2",
          "indivfolders",
        );
        IndividualFolders == "false" ? (folders = false) : (folders = true);
      } else {
        folders = false;
      }
      settings.individualFolder.value = folders;
      settings.individualFolder.onClick = IndividualFoldersFunct;
      if (app.settings.haveSetting("awautosaverV2", "versionsFolder")) {
        createVersionsFolder = app.settings.getSetting(
          "awautosaverV2",
          "versionsFolder",
        );
        createVersionsFolder == "false"
          ? (versions = false)
          : (versions = true);
      } else {
        versions = true;
      }
      settings.createVersions.value = versions;
      settings.createVersions.onClick = VersionsFolder;
      if (app.settings.haveSetting("awautosaverV2", "copyVersionsFolder")) {
        CopyVersions = app.settings.getSetting(
          "awautosaverV2",
          "copyVersionsFolder",
        );
        CopyVersions == "false" ? (copvers = false) : (copvers = true);
      } else {
        copvers = false;
      }
      settings.copyVersionsFolder.value = copvers;
      settings.copyVersionsFolder.onClick = CopVersionsFunct;
      vimeoButton.onClick = function () {
        OpenWebLink("https://vimeo.com/spylabs/aw-autosaver2");
      };
      updatesButton.onClick = function () {
        OpenWebLink("http://aescripts.com/aw-autosaver/");
      };
      emailButton.onClick = function () {
        OpenWebLink("mailto:support@spylabs.org");
      };
      closeButton = setPan2.add("button", undefined, "Close", { name: "ok" });
      ...
      UI1.onClick = function () {
        UI1.value = true;
        app.settings.saveSetting("awautosaverV2", "UI1", UI1.value);
        UI2.value = false;
        app.settings.saveSetting("awautosaverV2", "UI2", UI2.value);
        intervalBG.icon = ScriptUI.newImage(iconsUI[0]);
        autoSaverPanel.manSave.icon = ScriptUI.newImage(iconsUI[1]);
        if (parseFloat(app.version) < 12) {
          autoSaverPanel.chkBox.value == false
            ? (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconsUI[2]))
            : (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconsUI[3]));
        } else {
          autoSaverPanel.chkBox.icon = ScriptUI.newImage(
            iconsUI[2],
            undefined,
            iconsUI[3],
            undefined,
        ...
        autoSaverPanel.pathBt.icon = ScriptUI.newImage(iconsUI[4]);
        timeGroup.timeIcon.icon = ScriptUI.newImage(iconsUI[5]);
        pathIcon.icon = ScriptUI.newImage(iconsUI[6]);
        pathGroup.settings.icon = ScriptUI.newImage(iconsUI[7]);
        return;
      };
      UI2.onClick = function () {
        ...
        UI2.value = true;
        app.settings.saveSetting("awautosaverV2", "UI2", UI2.value);
        intervalBG.icon = ScriptUI.newImage(iconsUI2[0]);
        autoSaverPanel.manSave.icon = ScriptUI.newImage(iconsUI2[1]);
        if (parseFloat(app.version) < 12) {
          autoSaverPanel.chkBox.value == false
            ? (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconsUI2[2]))
            : (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconsUI2[3]));
        } else {
          autoSaverPanel.chkBox.icon = ScriptUI.newImage(
            iconsUI2[2],
            undefined,
        ...
        autoSaverPanel.pathBt.icon = ScriptUI.newImage(iconsUI2[4]);
        timeGroup.timeIcon.icon = ScriptUI.newImage(iconsUI2[5]);
        pathIcon.icon = ScriptUI.newImage(iconsUI2[6]);
        pathGroup.settings.icon = ScriptUI.newImage(iconsUI2[7]);
        return;
      };
    }
    ...
    var autosaverSettings = {};
    autosaverSettings.interval = "1";
    AWAS.fullName = File($.fileName).displayName;
    AWAS.scriptName = String(
      AWAS.fullName.match(".")
        ? AWAS.fullName.substring(0, AWAS.fullName.lastIndexOf("."))
        : AWAS.fullName,
    );
    autoSaverPanel =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", AWAS.scriptName, undefined, {
            resizeable: true,
          });
    autoSaverPanel.orientation = "column";
    autoSaverPanel.margins = 7;
    autoSaverPanel.spacing = 10;
    buttonsGroup = autoSaverPanel.add("group", undefined, "ButtonsUI");
    buttonsGroup.alignment = "left";
    buttonsGroup.margins = 0;
    buttonsGroup.spacing = 3;
    buttonSize = 46;
    infoButtonSize = 25;
    infoGroup = autoSaverPanel.add("group", undefined, "InfoUI");
    infoGroup.orientation = "column";
    infoGroup.alignment = ["fill", "fill"];
    infoGroup.margins = 0;
    infoGroup.spacing = 7;
    intervalGroup = buttonsGroup.add("group", undefined, {
      alignChildren: ["left", "top"],
      alignment: ["fill", "fill"],
      margin: 0,
      spacing: 0,
    });
    intervalGroup.orientation = "stack";
    if (app.settings.haveSetting("awautosaverV2", "UI1")) {
      UIswitch = app.settings.getSetting("awautosaverV2", "UI1");
      if (eval(UIswitch) == true) {
        iconFolder = iconsUI;
    ...
    intervalBG = intervalGroup.add(
      "image",
      [0, 0, buttonSize, buttonSize],
      iconFolder[0],
    );
    autoSaverPanel.txt = intervalGroup.add("edittext", undefined, "1", {
      alignChildren: ["center", "center"],
      alignment: ["fill", "fill"],
      margin: 0,
      spacing: 0,
    });
    autoSaverPanel.txt.size = [40, 40];
    if (parseFloat(app.version) < 12) {
      autoSaverPanel.txt.justify = "center";
    }
    autoSaverPanel.manSave = buttonsGroup.add(
      "iconbutton",
      [0, 0, buttonSize, buttonSize],
      iconFolder[1],
      { style: "toolbutton" },
    ...
    if (parseFloat(app.version) < 12) {
      autoSaverPanel.chkBox = buttonsGroup.add(
        "iconbutton",
        [0, 0, buttonSize, buttonSize],
        ScriptUI.newImage(iconFolder[2]),
        { toggle: true },
      );
    } else {
      autoSaverPanel.chkBox = buttonsGroup.add(
        "iconbutton",
        [0, 0, buttonSize, buttonSize],
        ScriptUI.newImage(iconFolder[2], undefined, iconFolder[3], undefined),
        { style: "toolbutton", toggle: true },
      );
    }
    autoSaverPanel.pathBt = buttonsGroup.add(
      "iconbutton",
      [0, 0, buttonSize, buttonSize],
      iconFolder[4],
      { style: "toolbutton" },
    );
    timeGroup = infoGroup.add("group", undefined, "TimeUI");
    timeGroup.orientation = "row";
    timeGroup.alignment = "left";
    timeGroup.timeIcon = timeGroup.add(
      "iconbutton",
      [0, 0, infoButtonSize, infoButtonSize],
      iconFolder[5],
      { style: "toolbutton" },
    );
    timeGroup.timeIcon.helpTip =
      "0 versions of current project saved\nClick to reveal \'\'project_versions\'\' folder";
    timeGroup.timeIcon.helpTip = getNumberOfVersions();
    timeGroup.savetime = timeGroup.add(
      "statictext",
      undefined,
      "When your project saved",
    );
    pathGroup = infoGroup.add("group", undefined, "PathUI");
    pathGroup.orientation = "row";
    pathGroup.alignment = ["fill", "fill"];
    pathIcon = pathGroup.add(
      "iconbutton",
      [0, 0, infoButtonSize, infoButtonSize],
      iconFolder[6],
      { style: "toolbutton" },
    );
    pathIcon.alignment = ["left", "top"];
    pathGroup.savepath = pathGroup.add(
      "statictext",
      undefined,
      "Where lastest copy of your project saved",
      { multiline: true },
    );
    pathGroup.savepath.alignment = ["fill", "fill"];
    pathGroup.settings = pathGroup.add(
      "iconbutton",
      [0, 0, 23, 23],
      iconFolder[7],
      { style: "toolbutton" },
    );
    pathGroup.settings.alignment = ["right", "bottom"];
    app.settings.haveSetting("awautosaverV2", "lastPath")
      ? (pathGroup.savepath.text = app.settings.getSetting(
          "awautosaverV2",
          "lastPath",
        ))
      : (pathGroup.savepath.text = "Where your last project saved");
    if (app.settings.haveSetting("awautosaverV2", "lastTime")) {
      timeGroup.savetime.text = app.settings.getSetting(
        "awautosaverV2",
        "lastTime",
      );
    } else {
      timeGroup.savetime.text = "When your last project saved";
    }
    if (app.settings.haveSetting("awautosaverV2", "interval")) {
      autosaverSettings.interval = app.settings.getSetting(
        "awautosaverV2",
        "interval",
      );
    } else {
    ...
    autoSaverPanel.txt.text = autosaverSettings.interval;
    helpTips();
    autoSaverPanel.txt.onChange = function () {
      var intervalNum = autoSaverPanel.txt.text;
      if (isNaN(intervalNum)) {
        txtval = 1;
        autoSaverPanel.txt.text = "1";
        app.settings.saveSetting("awautosaverV2", "interval", txtval);
    ...
    autosaverSettings.autosave = null;
    if (app.settings.haveSetting("awautosaverV2", "autosave")) {
      autosaverSettings.autosave = app.settings.getSetting(
        "awautosaverV2",
        "autosave",
      );
    } else {
      autosaverSettings.autosave = false;
    }
    autoSaverPanel.chkBox.value = eval(autosaverSettings.autosave);
    if (autoSaverPanel.chkBox.value == true) {
      autosaveToggle();
    }
    autoSaverPanel.pathBt.onClick = SavePath;
    autoSaverPanel.manSave.onClick = ManSave;
    pathIcon.onClick = openPath;
    timeGroup.timeIcon.onClick = openVersionsFolder;
    autoSaverPanel.chkBox.onClick = autosaveToggle;
    pathGroup.settings.onClick = about;
    autoSaverPanel.layout.layout(true);
    autoSaverPanel.layout.resize();
    autoSaverPanel.onResizing = autoSaverPanel.onResize = function () {
      this.layout.resize();
    };
    autoSaverPanel.show();
    autoSaverPanel.center();
    return autoSaverPanel;
  }
  function getNumberOfVersions() {
    if (app.project.file == null) {
      timeGroup.timeIcon.helpTip =
        "0 versions of current project saved\nClick to reveal \'\'project_versions\'\' folder";
      return "0 versions of current project saved\nClick to reveal \'\'project_versions\'\' folder";
    } else {
      try {
        var saveFile = app.project.file.fsName;
        var projectFileName = File.decode(app.project.file.name);
        var saveFile = saveFile.substring(
          0,
          saveFile.length - projectFileName.length,
        );
        VersionsFolder = File.decode(
          saveFile +
            projectFileName.substring(0, projectFileName.length - 4) +
            "%20(versions folder)",
        );
        var DesktopPath = new Folder(VersionsFolder);
        fileList = DesktopPath.getFiles();
        timeGroup.timeIcon.helpTip =
          fileList.length +
          " versions of current project saved\nClick to reveal \'\'project_versions\'\' folder";
      } catch (e) {}
    }
  }
  function projectSaveTime() {
    ...
    timeGroup.savetime.text = strDateTime;
    app.settings.saveSetting("awautosaverV2", "lastTime", strDateTime);
    autoSaverPanel.layout.layout();
  }
  function openPath() {
    if (app.project.file == null) {
      alert("Save or open your original project first");
      return false;
    }
    var ProjectPath = app.project.file.fsName;
    keyboardState = ScriptUI.environment.keyboardState;
    if (keyboardState.shiftKey) {
      if (app.settings.haveSetting("awautosaverV2", "copypath")) {
        var cutName = app.settings.getSetting("awautosaverV2", "copypath");
        cutName = new File(cutName + "/");
        ProjectPath = File.decode(cutName.fsName);
      } else {
        alert("You didn`t choose copy path yet.");
        return false;
      }
    } else {
      var cutName =
        ProjectPath.length - File.decode(app.project.file.name).length;
      ProjectPath = ProjectPath.substring(0, cutName);
    }
    if ($.os.indexOf("Win") != -1) {
      var cmd = "explorer " + String(ProjectPath);
    } else {
      var cmd = 'open "' + String(ProjectPath) + '"';
    }
    system.callSystem(cmd);
  }
  function openVersionsFolder() {
    if (app.project.file == null) {
      alert("Save or open your original project first");
      return false;
    }
    ...
    if (!new Folder(VersionsFolder).exists) {
      alert("No versions folder found.");
      return false;
    }
    if ($.os.indexOf("Win") != -1) {
      var cmd = "explorer " + String(VersionsFolder);
    } else {
      var cmd = 'open "' + String(VersionsFolder) + '"';
    }
    system.callSystem(cmd);
  }
  function SavePath() {
    ...
    if (app.project.file == null) {
      ...
      if (app.settings.haveSetting("awautosaverV2", "copypath")) {
        fileLoc = app.settings.getSetting("awautosaverV2", "copypath");
      }
      if (fileLoc != null) {
        var path = fileLoc + "/" + app.project.file.name;
        TmpFile = new File(path);
      } else {
        TmpFile = new File(app.project.file);
      }
      var yourFile = TmpFile.saveDlg(
        "Choose folder where to save copy of your project",
        "After Effects files:*.aep,All Files:*.*",
      );
      if (yourFile == null) {
        alert("Please, choose folder where to save a copy");
        return false;
      } else {
        var flPath = yourFile.path;
        app.settings.saveSetting("awautosaverV2", "copypath", flPath);
        if (
          app.settings.haveSetting("awautosaverV2", "indivfolders") &&
          app.settings.getSetting("awautosaverV2", "indivfolders") == "true"
        ) {
          var curFile = app.project.file.name;
          curFile = curFile.substring(0, curFile.length - 4);
          if (app.settings.haveSetting("awautosaverV2", "copypath")) {
            flPath = app.settings.getSetting("awautosaverV2", "copypath");
          }
          copyFolder = new Folder(flPath + "/" + curFile + "/");
          if (!copyFolder.exists) {
            copyFolder.create();
          }
          IndivFile = copyFolder.toString() + "/" + yourFile.name.toString();
          yourFile = new File(IndivFile.toString());
          aepFileCopy = yourFile;
        } else {
          aepFileCopy = yourFile;
        }
      }
  ...
  function ManSave() {
    ...
    var versionComment = "";
    if (autoSaverPanel.chkBox.value == true) {
      app.cancelTask(task1);
    }
    if (keyboardState.altKey) {
      if (
        app.settings.haveSetting("awautosaverV2", "versionsFolder") &&
        app.settings.getSetting("awautosaverV2", "versionsFolder") == "true"
      ) {
        if (awasv2lcn("v").match(/^t/)) {
          alert(
            "Sorry. Adding comments to versions is not available in trial mode",
          );
          versionComment = "()";
        } else {
          versionComment = "(" + prompt("Add comment to version", "") + ")";
        }
        versionComment == "()" ? (versionComment = "") : versionComment;
      } else {
        alert(
          "To add coments to project versions,\nplease turn on \'\'Create versions folder\'\' function under settings menu.",
        );
      }
    }
    if (keyboardState.shiftKey) {
      ...
      if (app.project.file == null) {
        if (autoSaverPanel.chkBox.value == true) {
          alert("Open or create your project first.");
          app.scheduleTask("ManSave()", 30000, (repeat = false));
        }
      } else {
        app.project.save();
        var onlyProjectName = app.project.file.name.substring(
          0,
          app.project.file.name.length - 4,
        );
        if (app.settings.haveSetting("awautosaverV2", "copypath")) {
          fileLoc = app.settings.getSetting("awautosaverV2", "copypath");
          if (
            ...
            copyFolder = new Folder(fileLoc + "/" + onlyProjectName + "/");
            if (!copyFolder.exists) {
              copyFolder.create();
            }
            path = copyFolder.toString() + "/";
          } else {
            path = fileLoc + "/";
          }
          if (
            ...
            createVersions(onlyProjectName, path, versionComment);
            copyFile = new File(path + app.project.file.name);
            app.project.file.copy(copyFile);
          } else {
            copyFile = new File(path + app.project.file.name);
            app.project.file.copy(copyFile);
          }
          projectSaveTime();
          pathGroup.savepath.text = Folder.decode(copyFile);
          app.settings.saveSetting(
            "awautosaverV2",
            "lastPath",
            Folder.decode(copyFile),
          );
          getNumberOfVersions();
          if (autoSaverPanel.chkBox.value == true) {
            autosaveToggle();
          ...
          alert(
            "You have not selected folder where to save a copy of your project.\nPlease select folder first.",
          );
          SavePath();
          ManSave();
          return false;
  ...
  function createVersions(onlyProjectName, path, versionComment) {
    var onlyVersionNumber = [];
    if (
      app.settings.haveSetting("awautosaverV2", "copyVersionsFolder") &&
      app.settings.getSetting("awautosaverV2", "copyVersionsFolder") == "true"
    ) {
      var CopyVersions = app.settings.getSetting(
        "awautosaverV2",
        "copyVersionsFolder",
      );
    }
    var VersionsFolder = new Folder(
      app.project.file.path + "/" + onlyProjectName + "%20(versions folder)",
    );
    var versionsFilesList = VersionsFolder.getFiles();
    ...
    versionsList = [];
    if (versionsFilesList.length <= Versions) {
      newProjectVersion = new File(
        VersionsFolder.toString() +
          "/" +
          onlyProjectName +
          versionComment +
          "%20version_" +
          versionsFilesList.length +
          1 +
          ".aep",
      );
      var versionDecoded = Folder.decode(newProjectVersion);
      if (versionsFilesList.length < Versions) {
        app.project.file.copy(versionDecoded);
        if (CopyVersions == "true") {
          CopyVersionsFolder = new Folder(
            path + "/" + onlyProjectName + "%20(versions folder)",
          );
          if (!CopyVersionsFolder.exists) {
            CopyVersionsFolder.create();
          }
          getVersionsList = VersionsFolder.getFiles("*.aep");
          for (var v = 0; v <= Versions; v += 1) {
            getVersionsList[v];
            if (!getVersionsList[v]) {
              break;
            } else {
              copyfile = new File(getVersionsList[v]);
              copytarget = new File(
                CopyVersionsFolder.toString() + "/" + getVersionsList[v].name,
              );
              copyfile.copy(copytarget);
            }
          }
        }
      } else {
        ...
        var renameLayers = [];
        var sortLayers = [];
        for (var n = 0; n < Versions; n += 1) {
          VersionNum = versionsFilesList[n].name.substring(
            versionsFilesList[n].name.lastIndexOf("_") + 1,
            versionsFilesList[n].name.length - 4,
          );
          sortLayers.push([versionsFilesList[n].name, VersionNum]);
          sortLayers.sort(function (a, b) {
            return a[1] - b[1];
          });
        }
        for (var l = 0; l < sortLayers.length; l += 1) {
          renameLayers.push(sortLayers[l][0]);
        }
        var Nll = new File(VersionsFolder.toString() + "/" + renameLayers[0]);
        if (Nll.exists) {
          Nll.remove();
        }
        for (var r = 1; r < renameLayers.length; r += 1) {
          copy[r] = new File(VersionsFolder.toString() + "/" + renameLayers[r]);
          newIndex = Number(
            copy[r].name.substring(
              copy[r].name.lastIndexOf("_") + 1,
              copy[r].name.length - 4,
            ),
          );
          copy[r].rename(
            copy[r].name.substring(0, copy[r].name.lastIndexOf("_") + 1) +
              (newIndex - 1) +
              ".aep",
          );
        }
        ...
        if (CopyVersions == "true") {
          ...
          CopyVersionsFolder.remove();
          CopyVersionsFolder.create();
          getVersionsList = VersionsFolder.getFiles("*.aep");
          removeCopies = CopyVersionsFolder.getFiles("*.aep");
          for (var b = 0; b < Versions; b += 1) {
            removeCopies[b].remove();
          }
          for (var v = 0; v <= Versions; v += 1) {
            getVersionsList[v];
            if (!getVersionsList[v]) {
  ...
  function autosaveToggle() {
    var saveInt = autoSaverPanel.chkBox.value;
    if (parseFloat(app.version) < 12) {
      app.settings.haveSetting("awautosaverV2", "UI1") &&
      app.settings.getSetting("awautosaverV2", "UI1") == "true"
        ? (iconFolder = iconsUI)
        : (iconFolder = iconsUI2);
      autoSaverPanel.chkBox.value == false
        ? (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconFolder[2]))
        : (autoSaverPanel.chkBox.icon = ScriptUI.newImage(iconFolder[3]));
    }
    var interv = parseInt(autoSaverPanel.txt.text);
    if (autoSaverPanel.chkBox.value == true) {
      task1 = app.scheduleTask("ManSave()", interv * 60000, true);
    } else {
      app.cancelTask(task1);
    }
    app.settings.saveSetting("awautosaverV2", "autosave", saveInt);
  }
  function CopSave() {
    app.executeCommand(app.findMenuCommandId("Save a Copy..."));
  }
  ...
  var binaryIcons = [];
  var binaryIcons2 = [];
  AWAS.userDataFolder = new Folder(
    Folder.userData.fsName + "/Aescripts/aw_Autosaver",
  );
  if (!AWAS.userDataFolder.exists) {
    AWAS.userDataFolder.create();
  }
  binaryIcons[0] = [__BLOB__BLOB_000570__];
  binaryIcons[1] = [__BLOB__BLOB_000571__];
  binaryIcons[2] = [__BLOB__BLOB_000572__];
  binaryIcons[3] = [__BLOB__BLOB_000573__];
  binaryIcons[4] = [__BLOB__BLOB_000574__];
  binaryIcons[5] = [__BLOB__BLOB_000575__];
  binaryIcons[6] = [__BLOB__BLOB_000576__];
  binaryIcons[7] = [__BLOB__BLOB_000577__];
  iconsUI[0] = new File(AWAS.userDataFolder.toString() + "/Time-Interval.png");
  iconsUI[1] = new File(AWAS.userDataFolder.toString() + "/AEP.png");
  iconsUI[2] = new File(AWAS.userDataFolder.toString() + "/Off-button.png");
  iconsUI[3] = new File(AWAS.userDataFolder.toString() + "/On-button.png");
  iconsUI[4] = new File(AWAS.userDataFolder.toString() + "/Browse-Folder.png");
  iconsUI[5] = new File(AWAS.userDataFolder.toString() + "/Save-Time.png");
  iconsUI[6] = new File(AWAS.userDataFolder.toString() + "/Copy-Path.png");
  iconsUI[7] = new File(AWAS.userDataFolder.toString() + "/cog-icon.png");
  for (var u = 0; u <= 7; u += 1) {
    if (!iconsUI[u].exists) {
      iconsUI[u].encoding = "BINARY";
      iconsUI[u].open("w");
      iconsUI[u].write(binaryIcons[u]);
      iconsUI[u].close();
    }
  }
  binaryIcons2[0] = [__BLOB__BLOB_000578__];
  binaryIcons2[1] = [__BLOB__BLOB_000579__];
  binaryIcons2[2] = [__BLOB__BLOB_000580__];
  binaryIcons2[3] = [__BLOB__BLOB_000581__];
  binaryIcons2[4] = [__BLOB__BLOB_000582__];
  binaryIcons2[5] = [__BLOB__BLOB_000583__];
  binaryIcons2[6] = [__BLOB__BLOB_000584__];
  binaryIcons2[7] = [__BLOB__BLOB_000585__];
  iconsUI2[0] = new File(AWAS.userDataFolder.toString() + "/Time-Interval.png");
  iconsUI2[1] = new File(AWAS.userDataFolder.toString() + "/AEP_2.png");
  iconsUI2[2] = new File(AWAS.userDataFolder.toString() + "/Off-button_2.png");
  iconsUI2[3] = new File(AWAS.userDataFolder.toString() + "/On-button_2.png");
  iconsUI2[4] = new File(
    AWAS.userDataFolder.toString() + "/Browse-Folder_2.png",
  );
  iconsUI2[5] = new File(AWAS.userDataFolder.toString() + "/Save-Time_2.png");
  iconsUI2[6] = new File(AWAS.userDataFolder.toString() + "/Copy-Path_2.png");
  iconsUI2[7] = new File(AWAS.userDataFolder.toString() + "/cog-icon_2.png");
  for (var u = 0; u <= 7; u += 1) {
    if (!iconsUI2[u].exists) {
      iconsUI2[u].encoding = "BINARY";
      iconsUI2[u].open("w");
      iconsUI2[u].write(binaryIcons2[u]);
      iconsUI2[u].close();
    }
  }
  OnePath4All = "false";
