...
function b(vars) {
  ...
  var mx = __BLOB__BLOB_000108__;
  var wx = __BLOB__BLOB_000109__;
...
if (g2.c()) {
  (function (thisObj) {
    function buildUI(thisObj) {
      ...
      function myP_apply() {
        ...
        if (myLayers.length > 0) {
          for (var ii = 0; ii < myLayers.length; ii += 1) {
            var myProp = myLayers[ii].property("Effects");
            for (var i = 1; i <= myProp.numProperties; i += 1) {
              if (myProp.property(i).name == "Faux Parent - Position") {
                hasEffect = true;
              }
            }
          }
          if (!hasEffect) {
            ...
            alert(
              "The layer(s) selected already has Faux Parent - Position applied.",
            );
          }
        }
      }
      function myS_apply() {
        ...
        if (myLayers.length > 0) {
          for (var ii = 0; ii < myLayers.length; ii += 1) {
            var myProp = myLayers[ii].property("Effects");
            for (var i = 1; i <= myProp.numProperties; i += 1) {
              if (myProp.property(i).name == "Faux Parent - Scale") {
                hasEffect = true;
              }
            }
          }
          if (!hasEffect) {
            ...
            alert(
              "The layer(s) selected already has Faux Parent - Scale applied.",
            );
          }
        }
      }
      function myR_apply() {
        ...
        if (myLayers.length > 0) {
          for (var ii = 0; ii < myLayers.length; ii += 1) {
            var myProp = myLayers[ii].property("Effects");
            for (var i = 1; i <= myProp.numProperties; i += 1) {
              if (myProp.property(i).name == "Faux Parent - Rotation") {
                hasEffect = true;
              }
            }
          }
          if (!hasEffect) {
            ...
            alert(
              "The layer(s) selected already has Faux Parent - Rotation applied.",
            );
          }
        }
      }
      function myO_apply() {
        ...
        if (myLayers.length > 0) {
          for (var ii = 0; ii < myLayers.length; ii += 1) {
            var myProp = myLayers[ii].property("Effects");
            for (var i = 1; i <= myProp.numProperties; i += 1) {
              if (myProp.property(i).name == "Faux Parent - Opacity") {
                hasEffect = true;
              }
            }
          }
          if (!hasEffect) {
            ...
            alert(
              "The layer(s) selected already has Faux Parent - Opacity applied.",
            );
          }
        }
      }
      function addPos() {
        function addMarker_P() {
          var myComp = app.project.activeItem;
          var myLayers = myComp.selectedLayers;
          var myMarker = new MarkerValue("FP_S");
          for (var i = 0; i < myLayers.length; i += 1) {
            var myProp = myLayers[i].effect("Faux Parent - Position")(
              "Position Offset",
            );
            myProp.selected = true;
            myLayers[i]
              .property("Marker")
              .setValueAtTime(app.project.activeItem.time, myMarker);
          }
        }
        function addKeys_P() {
          var myComp = app.project.activeItem;
          ...
          try {
            for (var ii = 0; ii < myLayers.length; ii += 1) {
              myLayers[ii].selected = false;
              var myProp = myLayers[ii].effect("Faux Parent - Position")(
                "Position Offset",
              );
              ...
              var myProp = myLayers[ii].property("Marker");
              for (var i = 1; i <= myProp.numKeys; i += 1) {
                if (myProp.keyValue(i).comment == "FP_S") {
                  myProp.removeKey(i);
                  break;
                }
              }
        ...
        function userSelect() {
          ...
          var myLayers = myComp.selectedLayers;
          for (var i = 0; i < myLayers.length; i += 1) {
            var myType = myLayers[i].effect("Faux Parent - Position")(
              "Position Parent Type",
            );
            try {
              if (parseInt(edittext1.text, 10) > 0) {
                myType.setValue(dropdown1.selection.index + 1);
              }
            } catch (err) {
              myType.setValue(1);
            }
        ...
        app.beginUndoGroup("Faux Parent - Position");
        var myComp = app.project.activeItem;
        var myLayers = myComp.selectedLayers;
        var ffxFile = File(
          File($.fileName).path + "/fp_presets/" + "FP_position.ffx",
        );
        for (var i = 0; i < myLayers.length; i += 1) {
          deselectAll(myComp);
          ...
          userSelect();
          myParent = myLayers[i].effect("Faux Parent - Position")(
            "Position Parent",
          );
          try {
      ...
      function addScale() {
        function addMarker_P() {
          ...
          var myMarker = new MarkerValue("FP_S");
          for (var i = 0; i < myLayers.length; i += 1) {
            var myProp = myLayers[i].effect("Faux Parent - Scale")(
              "Scale Offset",
            );
            myProp.selected = true;
            myLayers[i]
        ...
        function addKeys_P() {
          ...
          try {
            for (var ii = 0; ii < myLayers.length; ii += 1) {
              myLayers[ii].selected = false;
              var myProp = myLayers[ii].effect("Faux Parent - Scale")(
                "Scale Offset",
              );
              myProp.expressionEnabled = true;
              myProp.selected = true;
        ...
        function userSelect() {
          ...
          var myLayers = myComp.selectedLayers;
          for (var i = 0; i < myLayers.length; i += 1) {
            var myType = myLayers[i].effect("Faux Parent - Scale")(
              "Scale Parent Type",
            );
            try {
              if (parseInt(edittext1.text, 10) > 0) {
                myType.setValue(dropdown2.selection.index + 1);
              }
            } catch (err) {
              myType.setValue(1);
            }
        ...
        app.beginUndoGroup("Faux Parent - Scale");
        var myComp = app.project.activeItem;
        var myLayers = myComp.selectedLayers;
        var ffxFile = File(
          File($.fileName).path + "/fp_presets/" + "FP_scale.ffx",
        );
        for (var i = 0; i < myLayers.length; i += 1) {
          deselectAll(myComp);
          myLayers[i].selected = true;
          ...
          myProp.expressionEnabled = false;
          userSelect();
          myParent = myLayers[i].effect("Faux Parent - Scale")("Scale Parent");
          try {
            var myIndex = parseInt(edittext1.text, 10);
            myParent.setValue(myIndex);
            addMarker_P();
      ...
      function addRotation() {
        function addMarker_P() {
          ...
          var myMarker = new MarkerValue("FP_S");
          for (var i = 0; i < myLayers.length; i += 1) {
            var myProp = myLayers[i].effect("Faux Parent - Rotation")(
              "Rotation Offset",
            );
            myProp.selected = true;
            myLayers[i]
        ...
        function addKeys_P() {
          ...
          try {
            for (var ii = 0; ii < myLayers.length; ii += 1) {
              myLayers[ii].selected = false;
              var myProp = myLayers[ii].effect("Faux Parent - Rotation")(
                "Rotation Offset",
              );
              myProp.expressionEnabled = true;
              myProp.selected = true;
        ...
        function userSelect() {
          ...
          var myLayers = myComp.selectedLayers;
          for (var i = 0; i < myLayers.length; i += 1) {
            var myType = myLayers[i].effect("Faux Parent - Rotation")(
              "Rotation Parent Type",
            );
            try {
              if (parseInt(edittext1.text, 10) > 0) {
                myType.setValue(dropdown3.selection.index + 1);
              }
            } catch (err) {
              myType.setValue(1);
            }
        ...
        app.beginUndoGroup("Faux Parent - Rotation");
        var myComp = app.project.activeItem;
        var myLayers = myComp.selectedLayers;
        var ffxFile = File(
          File($.fileName).path + "/fp_presets/" + "FP_rotation.ffx",
        );
        for (var i = 0; i < myLayers.length; i += 1) {
          deselectAll(myComp);
          myLayers[i].selected = true;
          ...
          myProp.expressionEnabled = false;
          userSelect();
          myParent = myLayers[i].effect("Faux Parent - Rotation")(
            "Rotation Parent",
          );
          try {
            var myIndex = parseInt(edittext1.text, 10);
      ...
      function addOpacity() {
        function addMarker_P() {
          ...
          var myMarker = new MarkerValue("FP_S");
          for (var i = 0; i < myLayers.length; i += 1) {
            var myProp = myLayers[i].effect("Faux Parent - Opacity")(
              "Opacity Offset",
            );
            myProp.selected = true;
            myLayers[i]
        ...
        function addKeys_P() {
          ...
          try {
            for (var ii = 0; ii < myLayers.length; ii += 1) {
              myLayers[ii].selected = false;
              var myProp = myLayers[ii].effect("Faux Parent - Opacity")(
                "Opacity Offset",
              );
              myProp.expressionEnabled = true;
              myProp.selected = true;
        ...
        function userSelect() {
          ...
          var myLayers = myComp.selectedLayers;
          for (var i = 0; i < myLayers.length; i += 1) {
            var myType = myLayers[i].effect("Faux Parent - Opacity")(
              "Opacity Parent Type",
            );
            try {
              if (parseInt(edittext1.text, 10) > 0) {
                myType.setValue(dropdown4.selection.index + 1);
              }
            } catch (err) {
              myType.setValue(1);
            }
        ...
        app.beginUndoGroup("Faux Parent - Opacity");
        var myComp = app.project.activeItem;
        var myLayers = myComp.selectedLayers;
        var ffxFile = File(
          File($.fileName).path + "/fp_presets/" + "FP_opacity.ffx",
        );
        for (var i = 0; i < myLayers.length; i += 1) {
          deselectAll(myComp);
          myLayers[i].selected = true;
          ...
          myProp.expressionEnabled = false;
          userSelect();
          myParent = myLayers[i].effect("Faux Parent - Opacity")(
            "Opacity Parent",
          );
          try {
            var myIndex = parseInt(edittext1.text, 10);
      ...
      function addMarker_P() {
        ...
        try {
          ...
          alert("Select layer(s) with Faux Parent - Position applied.");
        }
      }
      function addKeys_P() {
        var myComp = app.project.activeItem;
      ...
      function addMarker_S() {
        ...
        try {
          ...
          alert("Select layer(s) with Faux Parent - Scale applied.");
        }
      }
      function addKeys_S() {
        var myComp = app.project.activeItem;
      ...
      function addMarker_R() {
        ...
        try {
          ...
          alert("Select layer(s) with Faux Parent - Rotation applied.");
        }
      }
      function addKeys_R() {
        var myComp = app.project.activeItem;
      ...
      function addMarker_O() {
        ...
        try {
          ...
          alert("Select layer(s) with Faux Parent - Opacity applied.");
        }
      }
      function addKeys_O() {
        var myComp = app.project.activeItem;
      ...
      var windowName = "Faux Parent";
      var myPanel =
        thisObj instanceof Panel
          ? thisObj
          : new Window("window", windowName, undefined, { resizeable: true });
      var verticaltabbedpanel1 = myPanel.add("group", undefined, undefined, {
      ...
      var verticaltabbedpanel1_nav = verticaltabbedpanel1.add(
        "listbox",
        undefined,
        ["Position", "Scale", "Rotation", "Opacity", "About"],
      );
      ...
      var dropdown1 = tab1.add("dropdownlist", undefined, undefined, {
        items: dropdown1_array,
        name: "dropdown1",
      });
      dropdown1.helpTip = "The Parent Index must be set to apply Parent Type.";
      dropdown1.selection = 0;
      var button1 = tab1.add("button", undefined, undefined, {
        name: "button1",
      });
      button1.text = "Apply";
      var button2 = tab1.add("button", undefined, undefined, {
        name: "button2",
      });
      button2.text = "Sync";
      ...
      var button3 = tab1.add("button", undefined, undefined, {
        name: "button3",
      });
      button3.text = "Remove";
      ...
      var dropdown2 = tab2.add("dropdownlist", undefined, undefined, {
        items: dropdown2_array,
        name: "dropdown2",
      });
      dropdown2.helpTip = "The Parent Index must be set to apply Parent Type.";
      dropdown2.selection = 0;
      var button4 = tab2.add("button", undefined, undefined, {
        name: "button4",
      });
      button4.text = "Apply";
      var button5 = tab2.add("button", undefined, undefined, {
        name: "button5",
      });
      button5.text = "Sync";
      ...
      var button6 = tab2.add("button", undefined, undefined, {
        name: "button6",
      });
      button6.text = "Remove";
      ...
      tab3.spacing = 10;
      tab3.margins = 0;
      var dropdown3_array = ["Parent Type", "Standard", "Invert", "Target"];
      var dropdown3 = tab3.add("dropdownlist", undefined, undefined, {
        items: dropdown3_array,
        name: "dropdown3",
      });
      dropdown3.helpTip = "The Parent Index must be set to apply Parent Type.";
      dropdown3.selection = 0;
      var button7 = tab3.add("button", undefined, undefined, {
        name: "button7",
      });
      button7.text = "Apply";
      var button8 = tab3.add("button", undefined, undefined, {
        name: "button8",
      });
      button8.text = "Sync";
      var divider3 = tab3.add("panel", undefined, undefined, {
        name: "divider3",
      });
      divider3.alignment = "fill";
      var button9 = tab3.add("button", undefined, undefined, {
        name: "button9",
      });
      button9.text = "Remove";
      var tab4 = verticaltabbedpanel1_innerwrap.add("group", undefined, {
        name: "tab4",
      });
      tab4.text = "Opacity";
      ...
      tab4.spacing = 10;
      tab4.margins = 0;
      var dropdown4_array = ["Parent Type", "Standard", "Invert"];
      var dropdown4 = tab4.add("dropdownlist", undefined, undefined, {
        items: dropdown4_array,
        name: "dropdown4",
      });
      dropdown4.helpTip = "The Parent Index must be set to apply Parent Type.";
      dropdown4.selection = 0;
      var button10 = tab4.add("button", undefined, undefined, {
        name: "button10",
      });
      button10.text = "Apply";
      var button11 = tab4.add("button", undefined, undefined, {
        name: "button11",
      });
      button11.text = "Sync";
      var divider4 = tab4.add("panel", undefined, undefined, {
        name: "divider4",
      });
      divider4.alignment = "fill";
      var button12 = tab4.add("button", undefined, undefined, {
        name: "button12",
      });
      button12.text = "Remove";
      var tab5 = verticaltabbedpanel1_innerwrap.add("group", undefined, {
        name: "tab5",
      });
      tab5.text = "About";
      ...
      tab5.spacing = 10;
      tab5.margins = 0;
      verticaltabbedpanel1_tabs = [tab1, tab2, tab3, tab4, tab5];
      ...
      var statictext1 = tab5.add("statictext", undefined, undefined, {
        name: "statictext1",
      });
      statictext1.text = "Faux Parent v1.1";
      statictext1.justify = "center";
      statictext1.alignment = ["center", "top"];
      var button13 = tab5.add("button", undefined, undefined, {
        name: "button13",
      });
      button13.text = "Help";
      ...
      statictext2.text = "Parent Index";
      var edittext1 = group1.add(
        'edittext {justify: "center", properties: {name: "edittext1"}}',
      );
      edittext1.helpTip = "Enter the parent layer index.";
      edittext1.preferredSize.width = 40;
      button1.onClick = myP_apply;
      button2.onClick = syncPos;
      button3.onClick = removePos;
      button4.onClick = myS_apply;
      button5.onClick = syncScale;
      button6.onClick = removeScale;
      button7.onClick = myR_apply;
      button8.onClick = syncRotation;
      button9.onClick = removeRotation;
      button10.onClick = myO_apply;
      button11.onClick = syncOpacity;
      button12.onClick = removeOpacity;
      button13.onClick = myHelp;
    ...
    function removePos() {
      var myComp = app.project.activeItem;
      var myLayers = myComp.selectedLayers;
      app.beginUndoGroup("Remove Faux Parent - Position");
      for (var i = 0; i < myLayers.length; i += 1) {
        try {
          var myProp = myLayers[i].effect("Faux Parent - Position");
          myProp.remove();
    ...
    function removeScale() {
      var myComp = app.project.activeItem;
      var myLayers = myComp.selectedLayers;
      app.beginUndoGroup("Remove Faux Parent - Scale");
      for (var i = 0; i < myLayers.length; i += 1) {
        try {
          var myProp = myLayers[i].effect("Faux Parent - Scale");
          myProp.remove();
    ...
    function removeRotation() {
      var myComp = app.project.activeItem;
      var myLayers = myComp.selectedLayers;
      app.beginUndoGroup("Remove Faux Parent - Rotation");
      for (var i = 0; i < myLayers.length; i += 1) {
        try {
          var myProp = myLayers[i].effect("Faux Parent - Rotation");
          myProp.remove();
    ...
    function removeOpacity() {
      var myComp = app.project.activeItem;
      var myLayers = myComp.selectedLayers;
      app.beginUndoGroup("Remove Faux Parent - Opacity");
      for (var i = 0; i < myLayers.length; i += 1) {
        try {
          var myProp = myLayers[i].effect("Faux Parent - Opacity");
          myProp.remove();
