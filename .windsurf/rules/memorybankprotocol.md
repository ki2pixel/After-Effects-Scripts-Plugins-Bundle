...
Access these via `fast_read_file`, `fast_edit_block`, or `fast_list_directory` using absolute paths in `/home/kidpixel/After_Effects_Scripts_Plugins_Bundle/memory-bank/`.
