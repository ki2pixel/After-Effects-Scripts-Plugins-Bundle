...
- **Available Tools**: Les 5 outils disponibles sont : `fast_read_file`, `fast_edit_block`, `fast_write_file`, `fast_get_directory_tree`, `fast_list_directory`.
...
- **Updating**: Utilisez l'outil `fast_edit_block` avec `path` (chemin absolu) pour synchroniser l'état du projet en fin de tâche.
