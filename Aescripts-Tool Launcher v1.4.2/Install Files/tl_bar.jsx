...
var rgTLBar = function (thisObj) {
  ...
  var aeq = (function () {
    ...
    aeq.extend = function () {
      ...
      if (typeof f !== "object" && !aeq.isFunction(f)) {
        f = {};
      }
      if (h === B) {
        f = this;
    ...
    var h = { setters: { "[object Property]": { value: "setValue" } } };
    aeq.extend({
    ...
    aeq.select = function (i, n) {
      ...
      while (I.length > 0) {
        ...
        switch (A.type) {
          case "activecomp":
            j = h(aeq.arrayEx([aeq.getActiveComposition()]));
            j.type = "comp";
            break;
          case "composition":
          case "comp":
            j = h(aeq.getCompositions());
            j.type = "comp";
            break;
          case "layer":
          ...
          case "prop":
            if (
              ...
              j = h(aeq.getProperties(j, { separate: false }));
              j.type = "property";
            } else {
              if (j.type !== "layer") {
                I.unshift({ type: "layer" });
    ...
    aeq.extend({
      createResourceFiles: function (i, A, f) {
        ...
        aeq.forEach(i, function (i, n) {
          var j = aeq.file.joinPath(A.fsName, i + f);
          var k = new File(j);
          h[i] = k;
          if (!k.exists || n.length !== k.length) {
            ...
            if (!I) {
              if (k.error === "") {
                ...
                h[i] = new Error(k.error, k.fsName, undefined);
              }
            }
            k.close();
          }
  ...
  var cssselector = (function () {
    ...
    function n(B) {
      ...
      function Vn(i) {
        throw an(i, null, B.substring(Nn, Ln), Tn(Nn, Ln));
      }
      function dn(i) {
        var n = Dn[i];
        if (n) {
      ...
      function pn() {
        i = Ln;
        if (B.substr(Ln, 2).toLowerCase() === X) {
          n = B.substr(Ln, 2);
          Ln += 2;
        } else {
          n = m;
      ...
      var e = "=";
      var M = { description: '"="', type: "literal", value: "=" };
      var Y = function (i, n) {
        var j = {};
        var k = i.join("");
        j[k] = n;
      ...
      var a = "0";
      var S = { description: '"0"', type: "literal", value: "0" };
      var Z = /^[0-9]/;
      ...
      var t = function () {
        return { type: "Number", value: parseFloat(Pn()) };
      };
      var W = function () {
        return { type: "Integer", value: parseFloat(Pn()) };
      };
      var X = "0x";
      var R = { description: '"0x"', type: "literal", value: "0x" };
      var r = function (i) {
      ...
      var x = "\\";
      var z = { description: '"\\\\"', type: "literal", value: "\\" };
      ...
      var Ai = "f";
      var fi = { description: '"f"', type: "literal", value: "f" };
      var hi = function () {
        return "\f";
      };
      var Bi = "n";
      ...
      var Qi = "v";
      var ei = { description: '"v"', type: "literal", value: "v" };
      var Mi = function () {
        return "\v";
      };
      var Yi = "x";
      var Pi = { description: '"x"', type: "literal", value: "x" };
      var Ci = "u";
      ...
      var ti = "\u2029";
      var Wi = { description: '"\\u2029"', type: "literal", value: "\u2029" };
      var Xi = function (i, n) {
        i.push(n);
        return { type: "Array", value: i };
      };
      var Ri = ",";
      var ri = { description: '","', type: "literal", value: "," };
      var gi = function (i) {
        return i;
      };
      var oi = "true";
      ...
      var zi = { description: "regular expression", type: "other" };
      var wi = "/";
      ...
      var An = /^[\\\/[]/;
      var fn = { description: "[\\\\/[]", type: "class", value: "[\\\\/[]" };
      var hn = function (i) {
        return "\\" + i;
      };
      var Bn = function (i) {
  ...
  function a(vars) {
    ...
    var maxUIButtons = 3;
    var licV = 2;
    var wx = __BLOB__BLOB_000677__;
    var mx = __BLOB__BLOB_000678__;
  ...
  if (typeof rgtlDebug !== "undefined" && rgtlDebug === true) {
    globalToolbox = {};
  } else {
    globalToolbox = typeof globalToolbox !== "undefined" ? globalToolbox : {};
  }
  var toolbox = (function () {
    if (globalToolbox.lib !== undefined) {
      var oldTB = globalToolbox.lib;
      if (oldTB.script.version >= script.version) {
        return oldTB;
      } else {
        try {
          oldTB.save();
        } catch (i) {}
        globalToolbox.lib = tb;
        oldTB.redefine();
      }
    }
    ...
    (function () {
          ...
          if (i.length) {
            ...
            aeq.forEach(i, function (i) {
              var n = {
                ...
                name: f(decodeURIComponent(i.name)),
                settings: "aescriptSettings",
              };
      ...
      function F() {
        if (
          tb.isTrial &&
          tb.config.tools.length > tb.trialLimit.maxConfigTools
        ) {
      ...
      (function () {
        function n(i) {
          tb.settings.libraries.push(i.fsName);
        }
        aeq.extend(tb, {
          addLibraries: function (i) {
            aeq.forEach(i, n);
            tb.initRun();
          },
          addLibrary: function (i) {
            n(i);
            tb.initRun();
          },
          removeLibrary: function (i) {
            var n = tb.settings.libraries;
      ...
      (function () {
        ...
        var f = { cmd: "", showInList: false, showInPanel: false, type: "" };
      })();
      (function () {
      ...
      aeq.extend(tb, {
        addFolder: function (i) {
          ...
          toolbox.config.folders.push(i);
          tb.configChangedSinceSave = true;
        },
        removeFolder: function (n) {
          tb.config.folders = aeq.filter(tb.config.folders, function (i) {
            return i !== n;
          });
          A();
          tb.configChangedSinceSave = true;
      ...
      tb.ui = (function () {
        ...
        N.icon = {
          arrowDown: __BLOB__BLOB_000679__,
          arrowLeft: __BLOB__BLOB_000680__,
          arrowRight: __BLOB__BLOB_000681__,
          arrowUp: __BLOB__BLOB_000682__,
          close: __BLOB__BLOB_000683__,
          create: __BLOB__BLOB_000684__,
          hide: __BLOB__BLOB_000685__,
          hideEnabled: __BLOB__BLOB_000686__,
          maximize: __BLOB__BLOB_000687__,
          minimize: __BLOB__BLOB_000688__,
          refresh: __BLOB__BLOB_000689__,
          remove: __BLOB__BLOB_000690__,
          settings: __BLOB__BLOB_000691__,
          star: __BLOB__BLOB_000692__,
          starEnabled: __BLOB__BLOB_000693__,
        };
        (function () {
          var A = true;
        ...
        N.createInfoPanel = function (i, n) {
          ...
          aeq.extend(f, {
            commandEditor: function (i) {
              ...
              if (i === "script" || i === "javascript") {
                B.showInList.value = f.cmd.showInList;
                B.showInList.enabled = true;
                B.showInPanel.value = f.cmd.showInPanel;
            ...
            load: function (i) {
              ...
              f.hide.value = i.hide;
              f.name.text = i.name;
              f.shortname.text = i.shortname || "";
              f.description.text = i.description || "";
              f.icon.setImage();
              f.updateCommand();
              f.toolbar.init();
            },
          ...
          var j = (f.panel = i.addPanel({
            alignChildren: ["fill", "top"],
            alignment: N.u.fill,
            text: "Tool settings",
          }));
          j.btns = j.addGroup({ alignChildren: ["left", "top"] });
          f.star = j.btns.addIconButton({
            helpTip: "Favourite; Shows on top in lists",
            image: N.icon.starImage,
            onClick: f.getSetterFunction("tool", "star", "value"),
            properties: { toggle: true },
            size: [30, 30],
          });
          f.hide = j.btns.addIconButton({
            helpTip: "Hide; Do not show in lists",
            image: N.icon.hideImage,
            onClick: f.getSetterFunction("tool", "hide", "value"),
            properties: { toggle: true },
            size: [30, 30],
          });
          f.toolbar = j.btns.addDropdownList({
            helpTip: "Add tool to toolbar",
            onChange: function () {
              if (this.selection) {
                tb.addToolToToolbar(f.tool, this.selection.toolbar);
                tb.softRefresh();
                this.selection = null;
              }
            },
          ...
          f.toolbar.init = function () {
            tb.addToolbarsToList(f.toolbar);
          };
          var k = j.addGroup({ alignChildren: ["fill", "fill"] });
          k.addStatictext({ alignment: ["left", "fill"], text: "Name:" });
          f.name = k.addEditText({
            onChange: function () {
              if (f.tool !== null) {
                f.setValue("tool", "name", this.text);
                if (n && n.updateName) {
                  n.updateName(tb.getToolName(f.tool));
                }
              }
            },
          });
          ...
          f.shortname = k.addEditText({
            helpTip: "Used when not enough room to show full name",
            onChange: function () {
              if (f.tool !== null) {
                f.setValue("tool", "shortname", this.text);
                if (n && n.updateName) {
                  n.updateName(tb.getToolName(f.tool));
                }
              }
          ...
          f.description = I.addEditText({
            helpTip: "Used as a helpTip in toolbars",
            onChange: f.getSetterFunction("tool", "description", "text"),
          });
          ...
          f.icon.setImage = function () {
            var i = tb.getIcon(f.tool);
            if (i) {
              f.icon.visible = true;
              f.icon.image = i.fsName;
          ...
          if ($.os.indexOf("Windows") === -1) {
            ...
            A.fileFilter = function (i) {
              return i instanceof Folder || h.test(i.name);
            };
          } else {
            ...
            onClick: function () {
              if (f.tool !== null) {
                ...
                if (i) {
                  ...
                  if (j) {
                    f.setValue("tool", "icon", j);
                    f.icon.setImage(f.tool);
                    tb.configChangedSinceSave = true;
                  } else {
          ...
          B.events = {
            effectCategoryChange: function () {
              ...
              aeq.forEach(i, function (i) {
                ...
                if (
                  f.cmd &&
                  f.cmd.cmd.toLowerCase() === i.matchName.toLowerCase()
                ) {
                  j.selection = n;
                }
              });
            ...
            effectChange: function () {
              ...
              f.setValue("cmd", "cmd", this.selection.effectMatchName);
            },
            filePathClick: function () {
              if (f.cmd !== null) {
                if (f.cmd && f.cmd.cmd instanceof i) {
                  n = f.cmd;
                } else {
                  if (f.previousScriptFile) {
                    n = f.previousScriptFile.parent;
                  }
                }
                if (f.cmd.type === "script") {
                  j = tb.jsxFileFilter();
                } else {
                  if (f.cmd.type === "animation preset") {
                    j = tb.ffxFileFilter();
                  }
                }
                if (n) {
                ...
                if (i !== null) {
                  f.setValue("cmd", "cmd", i.fsName);
                  B.contents.filePath.path.text = f.cmd.cmd;
                } else {
            ...
            typeOnChange: function () {
              if (this.selection === null) {
                ...
                var i = f.commandEditor(this.selection.text);
                if (f.cmd) {
                  f.cmd.type = this.selection.text;
                  f.setValue("cmd", "type", this.selection.text);
          ...
          B.showInList = B.editCmdGrp.addCheckbox({
            ...
            onClick: function () {
              if (f.cmd !== null) {
                f.setValue("cmd", "showInList", this.value);
              }
            },
          ...
          B.showInPanel = B.editCmdGrp.addCheckbox({
            helpTip:
              "Show the UI in an external panel, if the panel is available.",
            onClick: f.getSetterFunction("cmd", "showInPanel", "value"),
          ...
          B.contents.textBox = B.contents.addEditText({
            alignment: N.u.fill,
            minimumSize: [200, 100],
            onChange: f.getSetterFunction("cmd", "cmd", "text"),
            properties: { multiline: true },
          });
          B.contents.filePath = B.contents.addGroup({
            alignment: ["fill", "top"],
          });
          ...
          B.contents.effectGroup.category =
            B.contents.effectGroup.addDropdownList({
              alignment: ["fill", "fill"],
              onChange: B.events.effectCategoryChange,
              text: "Category",
            });
          B.contents.effectGroup.dropdown =
            B.contents.effectGroup.addDropdownList({
              alignment: ["fill", "fill"],
          ...
          B.contents.btns.open = B.contents.btns.addButton(
            "Reveal",
            function () {
              if (f.cmd && f.cmd.cmd) {
                if (f.cmd.type.toLowerCase() === "script") {
                  if (f.cmd.cmd instanceof File) {
                    i = f.cmd.cmd.fsName;
                  } else {
                    i = f.cmd.cmd;
                  }
      ...
      tb.update = {
        ...
        download: function (i) {
          ...
          if (f[1].toUpperCase() !== "200 OK") {
            return new Error(f[1]);
          }
    ...
    (function (tbAeq) {
      ...
      tbAeq.extend(tb, {
        doCmd: function (i) {
          return tb.doType[i.type.toLowerCase()](i.cmd);
        },
        getCmd: function (i, n) {
          var j = tb.cmdName(n);
          var k = i[j];
          ...
          if (k !== undefined && k.type === "") {
            return new tb.PrettyError(
              "Command does not have a type",
              i.name + " does not have a type for " + j,
            );
          }
          if (k === undefined) {
            if (j === "cmd") {
        ...
        run: function (i, n) {
          var j = tb.getCmd(i, n);
          if (j instanceof tb.PrettyError) {
            return j;
          }
          return tb.doCmd(j);
        },
      ...
      tb.initRun = function () {
        ...
        i = libFile = undefined;
        tb.doType = {
          "animation preset": function (n) {
            if (aeq.isString(n) && aeq.isMac && n.length > 1001) {
              return new PrettyError("File path too long", n);
            }
            var i = tbAeq.getActiveComp();
            if (i === null) {
              alert(
            ...
            n = new File(n);
            if (n.exists) {
              app.beginUndoGroup("Apply preset " + n.name);
              tbAeq.forEach(i.selectedLayers, function (i) {
                i.applyPreset(n);
              });
              app.endUndoGroup();
            } else {
              return new PrettyError("File not found", n.fsName + " not found");
            }
          },
          effect: function (j) {
            var i = tbAeq.getActiveComp();
            ...
            app.beginUndoGroup("Add effect " + j);
            tbAeq.forEach(i.selectedLayers, function (i) {
              var n = i.property("ADBE Effect Parade");
              if (n !== null && n.canAddProperty(j)) {
                n.addProperty(j);
              }
            });
            app.endUndoGroup();
          ...
          expression: function (n) {
            var i = tbAeq.getActiveComp();
            if (i) {
              var j = i.selectedProperties;
              app.beginUndoGroup("Apply Expression");
              tbAeq.forEach(j, function (i) {
                if (i.canSetExpression) {
                  i.expression = n;
                }
              });
              app.endUndoGroup();
          ...
          menu: function (i) {
            var n = app.findMenuCommandId(i);
            if (n) {
              app.executeCommand(n);
            } else {
              return new tb.PrettyError(
                "Menu Command not found",
                'Could not find a menu command with the name "' + i + '"',
              );
            }
          },
          os: function (i) {
          ...
          script: function (i) {
            if (aeq.isString(i) && aeq.isMac && i.length > 1001) {
              return new PrettyError("File path too long", i);
            }
            try {
              i = new File(i);
              if (i.exists) {
                Folder.current = i.parent;
                k = $.evalFile(i);
              } else {
                k = new PrettyError("File not found", i.fsName + " not found");
              }
            } catch (i) {
              return i;
            }
    ...
    globalToolbox.lib = tb;
    tb.redefine = function () {
      aeq.extend(tb, globalToolbox.lib);
    };
    return tb;
  })();
  (function () {
    function I() {
      ...
      if (F.updateAvailable) {
        F.updateButton.visible = true;
        F.buttons.push(F.updateButton);
        J(F.updateButton, F.size);
      }
      aeq.forEach(F.tools, function (i) {
        j = tb.getIcon(i);
        if (j) {
          n = F.toolGrp.addIconButton({
            icon: j,
            properties: {
              style: F.settings.toolbutton ? "toolbutton" : undefined,
            },
          });
          l(n, F.size);
        } else {
          n = F.toolGrp.addButton();
          if (i.shortname && B(n, i.name).width > F.size.width) {
            n.text = i.shortname;
          } else {
            n.text = i.name;
          }
        ...
        n.helpTip = i.description || "";
        n.onClick = h;
        n.tool = i;
        F.buttons.push(n);
      });
      F.buttons.push(F.settingsBtn);
      if (!F.settings.hideToolbarSelect) {
        F.selectToolbar.visible = true;
        F.buttons.push(F.selectToolbar);
      } else {
        F.selectToolbar.visible = false;
      }
      n.update();
      A();
      f();
    ...
    function A() {
      F.settingsBtn.size = F.size;
      F.selectToolbar.size = F.size;
      F.settingsSpacing = F.size.spacingx;
      if (!F.settings.hideToolbarSelect && F.size.width > 40) {
        F.settingsBtn.size.width = F.size.width / 2;
        F.selectToolbar.size.width = F.size.width / 2;
        F.settingsSpacing = 1;
      }
    }
    function f() {
      ...
      var A = 0;
      var f = n.size().width;
      var h = F.size.spacingx;
      var B = F.size.spacingy;
      aeq.forEach(F.buttons, function (i, n, j) {
        i.location = [I, A];
        var k = i.size;
        if (n === j.length - 2) {
          I += k.width + F.settingsSpacing;
        } else {
          I += k.width + h;
        }
        if (j[n + 1] === undefined) {
    ...
    function h() {
      var i = this.tool;
      var n = tb.getModifiers();
      var j = tb.getCmd(i, n);
      if (j instanceof tb.PrettyError) {
        j.alert();
      } else {
        if (j.showInPanel && isValid(globalToolbox.panel)) {
          k = globalToolbox.panel.loadCmd(j);
        } else if (j.showInList && isValid(globalToolbox.launcher)) {
          k = globalToolbox.launcher.loadCmd(j, i);
        } else {
          k = tb.run(i, tb.getModifiers());
        }
      }
      if (k instanceof Error) {
        tb.ui.u.error(k);
      } else {
        if (k instanceof tb.PrettyError) {
          k.alert();
        }
      }
    }
    function B(i, n) {
      return i.graphics.measureString(n);
    }
    function m(i) {
      return i.graphics.measureString(i.text);
    }
    function E(i, n) {
      var j = Math.ceil(i / (n.width * 1)) * n.width;
      var k = j / n.width;
      var I = n.spacingx * (k - 1);
      return j + I;
    }
    function J(i, n) {
      var j = m(i);
    ...
    function L() {
      ...
      for (var n = i.children.length - 1; n >= 0; n--) {
        if (
          i.children[n] !== F.settingsBtn &&
          i.children[n] !== F.selectToolbar &&
          i.children[n] !== F.updateButton
        ) {
          i.remove(i.children[n]);
        }
      }
    ...
    var F = {
      ...
      settings: { hideToolbarSelect: false },
      settingsSpacing: 1,
      size: { height: 50, spacingx: 1, spacingy: 1, width: 50 },
      tools: [],
    };
    n =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", tb.script.name + " Toolbar", undefined, {
            resizeable: true,
          });
    var k = n;
    n = new aeq.ui.Window(n);
    n.set({
      margins: 0,
      onClose: function () {
        tb.unRegisterRefreshHandler(n.obj);
      },
      spacing: 0,
    });
    j = n.addGroup({
      alignment: tb.ui.u.fill,
      margins: 0,
      orientation: "stack",
      spacing: 0,
    });
    F.toolGrp = j.addGroup({
      alignChildren: ["left", "top"],
      alignment: tb.ui.u.fill,
      margins: 0,
      spacing: 0,
    });
    F.settingsBtn = F.toolGrp.addIconButton({
      icon: tb.ui.icon.settings,
      onClick: function () {
        var i = tb.getModifiers();
        if (i.altKey || i.shiftKey || i.ctrlKey || i.metaKey) {
          tb.refresh();
        } else {
          if (!F.settingsWindow || !F.settingsWindow.isOpen) {
            F.settingsWindow = N();
          }
          F.settingsWindow.get().show();
        }
      },
      size: F.size,
    });
    F.updateButton = F.toolGrp.addButton({
      onClick: function () {
        tb.update.openUpdateInfo(F.updateInfo, $.fileName);
      },
      size: F.size,
      text: "Update Available!",
      visible: false,
    });
    F.selectToolbar = F.toolGrp.addDropdownList({
      onChange: function () {
        if (!this.selection) {
          return;
        }
        var i = this.selection.toolbar;
        F.tools = tb.getToolbarTools(i);
        I();
        F.settings.lastUsedToolbar = i.name;
        var n = JSON.stringify(F.settings);
        aeq.settings.set(
          tb.script.name,
          tb.script.shortname + "_bar_settings_" + F.fileName,
          n,
        );
      },
      size: F.size,
    ...
    n.show();
    n.obj.onResize = n.obj.onResizing = function () {
      this.layout.resize();
      f();
    };
    F.loadTools = function (i) {
      F.tools = tb.getToolbarTools(t);
      if (F.tools !== undefined) {
        I();
      }
    };
    F.loadToolbars = function () {
      var k = F.selectToolbar.selection;
      if (k) {
        k = k.toolbar;
      } else {
        if (F.settings.lastUsedToolbar) {
          k = { name: F.settings.lastUsedToolbar };
        }
      }
      F.selectToolbar.removeAll();
      tb.forEachToolbar(function (i, n) {
        if (n === undefined) {
          return;
        }
        var j = F.selectToolbar.add("item", n.name);
        j.toolbar = n;
        if (k && n.name === k.name) {
          F.selectToolbar.selection = j;
        }
      });
      if (!F.selectToolbar.selection && F.selectToolbar.items.length) {
        F.selectToolbar.selection = 0;
      }
    };
    F.loadSettings = function () {
      var i = aeq.settings.get(
        tb.script.name,
        tb.script.shortname + "_bar_settings_" + F.fileName,
      );
      if (i !== undefined) {
      ...
      F.settings = i;
      F.settings.size = F.settings.size || F.size;
      F.size = F.settings.size;
    };
    tb.init();
    F.loadSettings();
    F.loadToolbars();
    ...
    F.softRefresh = function () {
      if (F.selectToolbar.selection) {
        F.tools = tb.getToolbarTools(F.selectToolbar.selection.toolbar);
        I();
      }
    };
    tb.registerRefreshHandler(F.refresh, j.obj);
    tb.registerSoftRefreshHandler(F.softRefresh, j.obj);
    if (tb.settings.updateOnLaunch) {
      F.updateInfo = tb.update.check("tl_bar");
      F.updateAvailable = F.updateInfo !== false;
      if (F.updateAvailable) {
        I();
      }
    }
    var N = function (n) {
      function E() {
        for (i = 0, il = m.toolbarGrp.list.items.length; i < il; i++) {
          var n = m.toolbarGrp.list.items[i];
          n.tool.toolbars[m.current.name].index = n.index;
          m.setter.changed(n.tool, "toolbars");
        }
      }
      var L = tb.ui;
      var j = new Window("palette", tb.script.name + " Settings", undefined, {
        resizeable: true,
      });
      j = new aeq.ui.Window(j);
      j.set({
        margins: [0, 0, 0, 0],
        onClose: function () {
          tb.save();
      ...
      var k = j.addGroup({
        alignChildren: L.u.fill,
        alignment: L.u.fill,
        margins: [0, 0, 0, 0],
        orientation: "stack",
      });
      var N = k.addTabbedPanel();
      j.tabs = N;
      N.set({
        onChange: function () {
          if (!tb.isCS6 && this.selection && this.selection.psuedoOnFocus) {
            this.selection.psuedoOnFocus();
          }
        },
      });
      k.addIconButton({
      ...
      var I = N.addTab("Tools");
      j.toolsTab = I;
      I.set({
        alignment: L.u.fill,
        orientation: "row",
        psuedoOnFocus: function () {
          I.dropdown.update();
        },
      });
      I.loadTools = function (i) {
        I.tools = i;
        I.tools.sort(tb.toolSorter);
        I.searchfield.notify();
      };
      I.listGrp = I.addGroup({
        alignChildren: ["fill", "top"],
        alignment: ["left", "fill"],
        minimumSize: [300, 200],
        orientation: "column",
      });
      I.info = tb.ui.createInfoPanel(I, {
        updateName: function (i) {
          var n = I.list.selection;
          if (n) {
            n.text = i;
          }
        },
      });
      I.info.panel.set({ minimumSize: [300, 200], preferredSize: [600, 200] });
      I.listGrp.btns = I.listGrp.addGroup({
        alignChildren: ["left", "fill"],
        alignment: ["fill", "top"],
      });
      I.listGrp.btns.addIconButton({
        helpTip: "Add new tool",
        image: L.icon.create,
        onClick: function () {
          if (I.dropdown.selection) {
            i = I.dropdown.selection.text;
            if (i !== "Your Tools" && i !== "All") {
              I.dropdown.selection = 1;
            }
          }
          if (
            tb.isTrial &&
            ...
            alert(
              "Cannot create more tools when using the trial version\nPlease purchase " +
                tb.script.name +
                " to use create more tools",
            );
            return;
          }
          var n = tb.create({ description: "", icon: "", name: "Untitled" });
          var j = I.list.add("item", n.name);
          j.tool = n;
          I.list.selection = j;
        },
      });
      I.listGrp.btns.addIconButton({
        ...
        image: L.icon.remove,
        onClick: function () {
          var i = I.list.selection;
          if (i !== null) {
            tb.remove(i.tool);
            I.list.selection = null;
            I.list.remove(i);
          }
        },
      });
      I.listGrp.btns.addCheckbox({
        onClick: function () {
          tb.settings.showHiddenTools = this.value;
          I.searchfield.notify();
        },
        text: "Show hidden",
        value: tb.settings.showHiddenTools,
      });
      I.dropdown = tb.ui.createFilterDropdown(I.listGrp, I.loadTools);
      I.searchfield = I.listGrp.addEditText({
        properties: { multiselect: true },
      });
      I.search = function () {
        I.list.removeAll();
        var i = tb.settings.showHiddenTools;
        tb.search(this.text, I.tools, I.list, i);
      };
      I.searchfield.addEventListener("changing", I.search);
      I.searchfield.addEventListener("change", I.search);
      I.list = I.listGrp.addListbox({ alignment: ["fill", "fill"] });
      I.list.addEventListener("change", function (i) {
        if (this.selection) {
          var n = this.selection.tool;
          I.info.modifiers = i;
          I.info.load(n);
        } else {
          I.info.modifiers = {};
      ...
      (function () {
        function h() {
          if (tb.configMissing) {
            i = new File(tb.settings.configPath).openDlg();
          } else if (I.text) {
            i = File(I.text).saveDlg();
          } else {
            i = File(tb.defaultConfigPath).saveDlg();
          }
          if (i) {
            tb.setConfig(i.fsName);
            I.text = i.fsName;
            tb.reInit();
            return true;
          }
        ...
        function J() {
          tb.removeFolder(E.selection.text);
          E.remove(E.selection);
          tb.reInit();
        }
        var i = N.addTab("Paths");
        i.set({
          alignChildren: L.u.fill,
          alignment: L.u.fill,
          psuedoOnFocus: function () {
            I.text = tb.settings.configPath || "";
            if (!tb.settings.configSet || tb.configMissing) {
              f.visible = true;
              var i = "Save config in non-default place";
              if (tb.configMissing) {
                i = "Cannot find a config file. Click to find it";
              }
              f.text = i;
              k.visible(false);
            } else {
        ...
        k.addButton({
          alignment: ["right", "fill"],
          onClick: function () {
            aeq.revealFile(tb.settings.configPath);
          },
          text: "Reveal",
        });
        var A = n.addGroup({ alignment: tb.ui.u.fill });
        var f = A.addButton({
          alignment: tb.ui.u.fill,
          onClick: function () {
            if (h()) {
        ...
        A.addButton({
          alignment: ["right", "fill"],
          onClick: function () {
            aeq.revealFile(tb.defaultConfigPath);
          },
          text: "Reveal config file",
        });
        var B = i.addPanel({ alignChildren: L.u.fill, text: "Folders" });
        B.btns = B.addGroup({
          alignChildren: ["left", "top"],
          alignment: ["fill", "top"],
        });
        B.btns.addButton({
          onClick: function () {
            if (tb.isTrial && tb.config.folders.length >= 1) {
              alert(
                "You can only add one folder when using trial version\nPlease purchase " +
                  tb.script.name +
                  " to add more folders",
              );
              return;
            }
            var i = Folder.selectDialog("Select folder to add");
            if (i) {
              F(i);
              if (tb.isTrial) {
                alert(
                  "When using the trial version the whole folder is not loaded\nPlease purchase " +
                    tb.script.name +
                    " to load the whole folder",
                );
              }
            }
          },
        ...
        var m = B.btns.addButton({ onClick: J, text: "Remove" });
        var E = B.addListbox({
          items: tb.config.folders,
          onChange: function () {
            m.enabled = E.selection !== null;
          },
        });
        var l = i.addPanel({ alignChildren: L.u.fill, text: "Import" });
        l.update = function () {
          l.list.removeAll();
          aeq.forEach(tb.tools.packs, function (i) {
            l.list.add("item", i);
          });
          l.list.notify();
        };
        ...
        l.btns.addButton({
          onClick: function () {
            if (tb.isTrial) {
              alert(
                "This feature is disabled when using trial version\nPlease purchase " +
                  tb.script.name +
                  " to use this feature",
              );
              return;
            }
            var i = File.openDialog("Select file to add", undefined, true);
            if (i) {
              aeq.forEach(i, tb.importPack);
              tb.reInit();
              l.update();
              alert("Done!");
            }
        ...
        l.btns.addButton({
          onClick: function () {
            ...
            var i = File.openDialog("Select file to add", undefined, true);
            if (i) {
              aeq.forEach(i, tb.importFullFTToolbar);
              tb.reInit();
              l.update();
              alert("Done!");
            }
          },
          text: "Import ft-toolbar config file",
        });
        l.list = l.addListbox({
          alignment: tb.ui.u.fill,
          onChange: function () {
            l.removeButton.enabled = this.selection !== null;
          },
        });
        l.removeButton = l.addIconButton({
          alignment: ["left", "bottom"],
          helpTip: "remove",
          image: L.icon.remove,
          onClick: function () {
            if (l.list.selection) {
              var i = l.list.selection.text;
              tb.removePack(i);
            }
            tb.reInit();
            l.update();
      ...
      var m = N.addTab("Toolbar tools");
      m.set({
        alignChildren: L.u.fill,
        alignment: L.u.fill,
        orientation: "row",
        psuedoOnFocus: function () {
          m.toolsGrp.dropdown.update();
          if (m.current) {
            k = m.current.name;
          } else {
            if (typeof F !== "undefined" && F.settings) {
              k = F.settings.lastUsedToolbar;
            }
          }
          m.info.toolbar.removeAll();
          m.toolbarGrp.list.removeAll();
          tb.forEachToolbar(function (i, n) {
            var j = m.info.toolbar.add("item", n.name);
            j.toolbar = n;
            if (k && n.name === k) {
              m.info.toolbar.selection = j;
            }
          });
          if (!m.info.toolbar.selection) {
            m.info.toolbar.selection = 0;
          }
          m.toolbarGrp.list.notify();
          m.toolsGrp.list.notify();
        },
      });
      m.setter = new tb.ToolSetter();
      m.loadTools = function (i) {
        m.tools = i;
        m.tools.sort(tb.toolSorter);
        m.toolsGrp.searchfield.notify();
      };
      m.toolsGrp = m.addGroup({
        alignChildren: ["fill", "top"],
        orientation: "column",
      });
      m.toolsGrp.addCheckbox({
        onClick: function () {
          tb.settings.showHiddenTools = this.value;
          m.toolsGrp.searchfield.notify();
        },
      ...
      m.toolsGrp.dropdown = tb.ui.createFilterDropdown(m.toolsGrp, m.loadTools);
      m.toolsGrp.searchfield = m.toolsGrp.addEditText();
      m.toolsGrp.search = function () {
        var i = tb.settings.showHiddenTools;
        tb.search(this.text, m.tools, m.toolsGrp.list, i);
      };
      m.toolsGrp.searchfield.addEventListener("changing", m.toolsGrp.search);
      m.toolsGrp.searchfield.addEventListener("change", m.toolsGrp.search);
      m.toolsGrp.list = m.toolsGrp.addListbox({
        alignment: ["fill", "fill"],
        onChange: function () {
          var i = this.selection !== null;
          var n = m.current !== null;
          m.rearange.addToolToToolbar.enabled = i && n;
        },
        properties: { multiselect: true },
      });
      m.toolsGrp.list.addEventListener("keydown", function (i) {
        if (i.keyIdentifier === "Right") {
          i.preventDefault();
          m.rearange.addToolToToolbar.onClick();
        }
      });
      m.rearange = m.addGroup({
        alignment: ["left", "middle"],
        maximumSize: [30, 300],
        orientation: "column",
      });
      m.rearange.moveUp = m.rearange.addIconButton({
      ...
      m.rearange.moveDown = m.rearange.addIconButton({
      ...
      m.rearange.move = function (i) {
        var n = m.toolbarGrp.list.selection;
        var j = n[0].index;
        var k = n[n.length - 1].index;
        if (j > k) {
          var I = j;
          j = k;
          k = I;
        ...
        if (i > 0 && k === m.toolbarGrp.list.items.length - 1) {
          return;
        }
        m.rearange.moveTools(j, k, i);
      };
      m.rearange.moveTools = function (i, n, j) {
        var k = [];
        var I = m.toolbarGrp.list;
        for (var A = 0, f = I.items.length; A < f; A++) {
          k.push(I.items[A].tool);
        }
        I.removeAll();
        var h = j > 0 ? n + j : i + j;
        var B = j > 0 ? i : n;
        for (A = i; A <= n; A++) {
          k.splice(h, 0, k.splice(B, 1)[0]);
        }
        m.toolbarGrp.addTools(k);
        h = i + j;
        B = n + j;
        for (A = h; A <= B; A++) {
          I.items[A].selected = true;
        }
        E();
        tb.softRefresh();
      };
      m.rearange.addToolToToolbar = m.rearange.addIconButton({
        image: tb.ui.icon.arrowRight,
        maximumSize: [30, 30],
        onClick: function () {
          var i = m.toolsGrp.list.selection;
          if (i === null) {
            return;
          }
          var n = m.toolbarGrp.list.selection;
          if (n !== null) {
            k = n[n.length - 1].index + 1;
            m.toolbarGrp.list.selection = null;
          }
          aeq.forEach(i, function (i) {
            var n = i.tool;
            if (tb.addToolToToolbar(n, m.current, k)) {
              var j = m.toolbarGrp.addTool(n, k);
              m.setter.changed(n, "toolbars");
              j.selected = true;
            }
          });
          E();
      ...
      m.rearange.removeToolFromToolbar = m.rearange.addIconButton({
        image: tb.ui.icon.arrowLeft,
        maximumSize: [30, 30],
        onClick: function () {
          var i = m.toolbarGrp.list.selection;
          if (i === null) {
            return null;
          }
          var n = i[0].index;
          aeq.forEach(i, function (i) {
            if (tb.removeToolFromToolbar(i.tool, m.current)) {
              m.toolbarGrp.list.remove(i);
            }
          });
          m.toolbarGrp.list.selection = n;
          m.toolbarGrp.list.notify();
          tb.softRefresh();
        },
      });
      m.toolbarGrp = m.addGroup({ orientation: "column" });
      m.info = m.toolbarGrp.addPanel({
        alignChildren: "fill",
        alignment: ["fill", "top"],
        orientation: "column",
      });
      m.info.buttonsGrp = m.info.addGroup({});
      m.info.create = m.info.buttonsGrp.addIconButton({
        icon: tb.ui.icon.create,
        onClick: function () {
          var i = tb.createToolbar("untitled");
          if (i === false) {
            return;
          }
          var n = m.info.toolbar.add("item", i.name);
          n.toolbar = i;
          m.info.toolbar.selection = n;
          tb.refresh();
        },
      });
      m.info.remove = m.info.buttonsGrp.addIconButton({
        icon: tb.ui.icon.remove,
        onClick: function () {
          if (m.current.locked) {
            alert("This toolbar is part of a pack and cannot be deleted");
            return;
          }
          if (confirm("Are you sure? This action cannot be undone.")) {
            if (tb.deleteToolbar(m.current)) {
              m.info.toolbar.remove(m.info.toolbar.selection);
              m.info.toolbar.selection = null;
              tb.refresh();
            }
          }
        },
      });
      m.info.toolbarGrp = m.info.addGroup({
        alignChildren: ["fill", "fill"],
        alignment: ["fill", "fill"],
      });
      m.info.toolbarGrp.addStatictext({
        alignment: ["left", "fill"],
        text: "Toolbar:",
      });
      m.info.toolbar = m.info.toolbarGrp.addDropdownList({
        onChange: function () {
          var i = this.selection !== null;
          var n = i ? this.selection.toolbar : { name: "" };
          m.current = i ? n : null;
          m.info.name.text = n.name;
          var j = i ? tb.getToolbarTools(n) : [];
          m.toolbarGrp.addTools(j);
          m.info.remove.enabled = i;
          m.info.name.enabled = i;
          m.toolbarGrp.list.notify();
          m.toolsGrp.list.notify();
        },
      });
      m.info.nameGrp = m.info.addGroup({
        alignChildren: ["fill", "fill"],
        alignment: ["fill", "fill"],
      });
      m.info.nameGrp.addStatictext({
        alignment: ["left", "fill"],
        text: "Name:",
      });
      m.info.name = m.info.nameGrp.addEditText({
        onChange: function () {
          m.info.toolbar.selection.text = this.text;
          tb.renameToolbar(m.current, this.text);
          tb.refresh();
          m.info.update();
        },
      });
      m.toolbarGrp.list = m.toolbarGrp.addListbox({
        alignment: L.u.fill,
        onChange: function () {
          var i = this.selection !== null;
          m.rearange.moveUp.enabled = i;
          m.rearange.moveDown.enabled = i;
          m.rearange.removeToolFromToolbar.enabled = i;
        },
        properties: { multiselect: true },
      });
      m.toolbarGrp.list.addEventListener("keydown", function (i) {
        var n = i.keyIdentifier;
        if (n === "Left") {
          i.preventDefault();
          m.rearange.removeToolFromToolbar.onClick();
          return;
        }
      });
      m.toolbarGrp.addTools = function (i) {
        m.toolbarGrp.list.removeAll();
        aeq.forEach(i, m.toolbarGrp.addTool);
      };
      m.toolbarGrp.addTool = function (i, n) {
        var j = m.toolbarGrp.list.add("item", tb.getToolName(i), n);
        j.tool = i;
        return j;
      };
      if (tb.isCS6) {
      ...
      if (typeof F !== "undefined") {
        (function () {
          ...
          function A() {
            this.parent.children[0].value = parseInt(this.text, 10);
            this.parent.children[0].onChange();
          }
          function f() {
            var k = {};
            aeq.forEach(I, function (i, n) {
              var j = Math.round(n.value);
              k[i] = j;
              n.et.text = j;
            });
            return k;
          ...
          var i = N.addTab("Toolbar Settings");
          i.set({
            alignChildren: L.u.fill,
            alignment: L.u.fill,
            orientation: "column",
          ...
          n.update = function () {
            aeq.forEach(F.size, function (i, n) {
              var j = I[i];
              if (j !== undefined) {
                j.value = n;
                j.et.text = n;
          ...
          var j = { alignChildren: tb.ui.u.fill };
          var I = {};
          n.widthGrp = n.addGroup(j);
          n.widthGrp.addStaticText({ alignment: "left", text: "Width" });
          I.width = n.widthGrp.addSlider(0, 0, 200, k, k);
          I.width.et = n.widthGrp.addEditText("0", A);
          n.heightGrp = n.addGroup(j);
          n.heightGrp.addStaticText({ alignment: "left", text: "Height" });
          I.height = n.heightGrp.addSlider(0, 0, 200, k, k);
          I.height.et = n.heightGrp.addEditText("0", A);
          n.spacingxGrp = n.addGroup(j);
          n.spacingxGrp.addStaticText({ alignment: "left", text: "Spacing X" });
          I.spacingx = n.spacingxGrp.addSlider(0, 0, 200, k, k);
          I.spacingx.et = n.spacingxGrp.addEditText("0", A);
          n.spacingyGrp = n.addGroup(j);
          n.spacingyGrp.addStaticText({ alignment: "left", text: "Spacing Y" });
          I.spacingy = n.spacingyGrp.addSlider(0, 0, 200, k, k);
          I.spacingy.et = n.spacingyGrp.addEditText("0", A);
          var B = i.addGroup({
            alignChildren: ["fill", "top"],
            alignment: ["fill", "top"],
            text: "Create new toolbar panel",
          });
          B.addStaticText({
            alignment: ["left", "middle"],
            text: "Create new toolbar panel:",
          });
          B.name = B.addEditText({ text: tb.script.shortname + "_bar" });
          B.addButton({
            helpTip:
              "Duplicates the Toolbar panel file and puts it in the Script UI folder",
            onClick: function () {
              var i = B.name.text;
              var n = new File($.fileName);
              var j = new File(n.parent.fsName + "/" + i + ".jsxbin");
              if (j.exists) {
                alert(
              ...
              if (n.copy(j) === true) {
                alert(
                  'Success!\nA copy of this script was placed in "' +
                    j.fsName +
                    '"\n' +
                    "Restart After Effects for the panel to show in the window menu.",
                );
              } else {
                alert(
          ...
          m.update = function () {
            m.checkbox.value = F.settings.hideToolbarSelect;
            m.toolbutton.value = F.settings.toolbutton;
          };
          m.checkbox = m.addCheckbox({
            onClick: function () {
              F.settings.hideToolbarSelect = this.value;
              F.softRefresh();
            },
            text: "Hide Toolbar selector button",
          });
          m.toolbutton = m.addCheckbox({
            onClick: function () {
              F.settings.toolbutton = this.value;
              F.softRefresh();
            },
            text: "Only show icons",
          });
          if (tb.isCS6) {
            i.obj.psuedoOnFocus();
          }
      ...
      (function () {
        ...
        n.update = function () {
          n.editor.text = tb.settings.editor;
        };
        n.addStatictext({
          text:
            'Editor to use when opening tools for editing, default is "' +
            tb.defualtEditor +
            '" which opens the default program for the file\n',
        });
        n.editor = n.addEditText({
          onChange: function () {
            tb.settings.editor = this.text;
          },
        });
        var j = i.addPanel({
          alignChildren: ["fill", "top"],
        ...
        j.update = function () {
          j.list.removeAll();
          aeq.forEach(tb.settings.libraries, function (i) {
            j.list.add("item", i);
          });
        };
        j.addStatictext({
          text:
            "Add a paths to script file. The script file will run on panel launch and it\'s results will be available to scripts launched from " +
            tb.script.name,
        });
        var k = { alignChildren: ["left", "fill"] };
        j.btnGrp = j.addGroup({ alignment: ["fill", "top"] });
        j.btnGrp.addIconButton({
          helpTip: "Add Library",
          image: L.icon.create,
          onClick: function () {
            var i = File.openDialog("Select files to include", undefined, true);
            if (i) {
              tb.addLibraries(i);
              j.update();
            }
        ...
        j.btnGrp.addIconButton({
          helpTip: "Remove Library",
          image: L.icon.remove,
          onClick: function () {
            if (j.list.selection) {
              for (var i = j.list.selection.length - 1; i >= 0; i--) {
                if (tb.removeLibrary(j.list.selection[i].text)) {
                  j.list.remove(j.list.selection[i]);
                }
              }
            }
          },
        ...
        j.btnGrp.addIconButton({
          helpTip: "Run library files",
          image: L.icon.refresh,
          onClick: function () {
            tb.initRun();
          },
        });
        ...
        I.update = function () {
          I.license.text = j77b.getRegistration();
          I.information.text = tb.script.name + " v" + tb.script.version;
        };
        I.information = I.addStaticText();
        I.license = I.addStaticText();
        I.updateGrp = I.addGroup();
        I.updateGrp.addButton({
          onClick: j77b.doUpdateCheckNow,
          text: "Check for update now",
        });
        I.updateGrp.updateOnLaunch = I.updateGrp.addCheckbox({
          onClick: function () {
            j77b.doUpdateCheck(this.value);
          },
          text: "Check for update on launch",
          value: (I.updateGrp.updateOnLaunch = j77b.getUpdateCheckStatus()),
        });
        I.updateGrp.addButton({
          onClick: function () {
            if (j77b.r()) {
      ...
      j.obj.layout.layout(true);
      j.obj.layout.resize();
      j.obj.onResizing = j.obj.onResize = function () {
        this.layout.resize();
      };
      return j;
    };
    tb.ui.createSettings = N;
    if (tb.configMissing) {
      F.settingsWindow = N();
      F.settingsWindow.tabs.obj.selection = 1;
      F.settingsWindow.obj.show();
    }
  })();
};
rgTLBar(this);
