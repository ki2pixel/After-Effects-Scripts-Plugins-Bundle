...
var rgTLList = function (thisObj) {
  ...
  var cssselector = (function () {
    ...
    function n(B) {
      ...
      var M = "=";
      var e = { description: '"="', type: "literal", value: "=" };
      var Y = function (i, n) {
        var j = {};
        var k = i.join("");
        j[k] = n;
  ...
  function a(vars) {
    ...
    var maxUIButtons = 3;
    var licV = 2;
    var wx = __BLOB__BLOB_000694__;
    var mx = __BLOB__BLOB_000695__;
  ...
  var toolbox = (function () {
    ...
    (function () {
      ...
      tb.ui = (function () {
        ...
        N.icon = {
          arrowDown: __BLOB__BLOB_000696__,
          arrowLeft: __BLOB__BLOB_000697__,
          arrowRight: __BLOB__BLOB_000698__,
          arrowUp: __BLOB__BLOB_000699__,
          close: __BLOB__BLOB_000700__,
          create: __BLOB__BLOB_000701__,
          hide: __BLOB__BLOB_000702__,
          hideEnabled: __BLOB__BLOB_000703__,
          maximize: __BLOB__BLOB_000704__,
          minimize: __BLOB__BLOB_000705__,
          refresh: __BLOB__BLOB_000706__,
          remove: __BLOB__BLOB_000707__,
          settings: __BLOB__BLOB_000708__,
          star: __BLOB__BLOB_000709__,
          starEnabled: __BLOB__BLOB_000710__,
        };
        (function () {
          var A = true;
  ...
  (function () {
    function j(i) {
      tb.search(this.text, k.tools, k.list, false);
      if (k.updateAvailable && this.text === "") {
        var n = k.list.add("item", k.updateTool.name, 0);
        n.tool = k.updateTool;
      }
      if (this.text !== "") {
        k.list.selection = 0;
    ...
    function E() {
      ...
      n = this.selection.tool;
      if (n.isTLupdateTool && n.cmd instanceof Function) {
        n.cmd();
        return;
      }
      j = tb.getCmd(n, tb.getModifiers());
      if (j instanceof tb.PrettyError) {
        j.alert();
      } else {
        if (j.showInPanel && isValid(globalToolbox.panel)) {
          i = globalToolbox.panel.loadCmd(j);
        } else if (j.showInList) {
          i = F(n, j);
        } else {
          i = tb.doCmd(j);
        }
      ...
      if (i instanceof Error) {
        ...
        if (i instanceof tb.PrettyError) {
          i.alert();
        }
      }
      I.update();
    ...
    function F(i, n) {
      f = A.addPanel({ alignment: ["fill", "fill"], margins: 5, text: i.name });
      f = f.get();
      I.update();
      var j = l(n).call(f, n.cmd);
      I.update();
      var k = f.size.height + A.btns.obj.size.height;
      L(k);
      return j;
    }
    function J() {
      if (A.up) {
        k.maximizeButton.onClick();
      }
      h();
      k.list.selection = null;
      I.update();
    }
    function l(i) {
      return tb.doType[i.type.toLowerCase()];
    }
    function L(i) {
      var n = A.obj;
      n.minimumSize.height = i;
      n.maximumSize.height = i;
      if (n.size) {
        n.size.height = i;
      }
    }
    var tb = toolbox;
    var k = { filename: $.fileName };
    var f = null;
    I =
      thisObj instanceof Panel
        ? thisObj
        : new Window("palette", tb.script.name + " list", undefined, {
            resizeable: true,
          });
    globalToolbox.launcher = I;
    I = new aeq.ui.Window(I);
    I.set({
      margins: 0,
      onClose: function () {
        tb.unRegisterRefreshHandler(I.obj);
      },
    });
    n = I.addGroup({
      alignChildren: tb.ui.u.fill,
      alignment: tb.ui.u.fill,
      margins: 0,
      orientation: "column",
      spacing: 3,
    });
    k.listGrp = n.addGroup({
      alignChildren: tb.ui.u.fill,
      alignment: tb.ui.u.fill,
      orientation: "column",
      spacing: 4,
    });
    k.searchGrp = k.listGrp.addGroup({
      alignChildren: tb.ui.u.fill,
      alignment: ["fill", "top"],
      margins: [3, 0, 3, 0],
      spacing: 0,
    });
    k.searchfield = k.searchGrp.addEditText();
    k.searchfield.maximumSize.height = 20;
    k.searchfield.addEventListener("changing", j);
    k.searchfield.addEventListener("change", j);
    k.searchfield.addEventListener("keydown", function (i) {
      var n = i.keyIdentifier;
      if (n === "Enter") {
        k.list.onDoubleClick();
      } else {
        if (n === "Down" || n === "Up") {
          i.preventDefault();
          j = k.list.selection !== null ? k.list.selection.index : 0;
          if (n === "Up" && j !== 0) {
            k.list.selection = j - 1;
          }
          if (n === "Down" && j !== k.list.items.length) {
            k.list.selection = j + 1;
          }
        }
      }
    });
    k.searchGrp.addButton({
      alignment: ["right", ""],
      maximumSize: [20, 20],
      onClick: function () {
        k.searchfield.text = "";
        j.call(k.searchfield);
      },
      text: "x",
    });
    k.searchGrp.addIconButton({
      alignment: ["right", ""],
      icon: tb.ui.icon.refresh,
      maximumSize: [20, 20],
      onClick: function () {
    ...
    k.settingsBtn = k.searchGrp.addIconButton({
      alignment: ["right", ""],
      image: tb.ui.icon.settings,
      maximumSize: [20, 20],
      onClick: function () {
        if (!k.settingsWindow || !k.settingsWindow.isOpen) {
          k.settingsWindow = N();
        }
        k.settingsWindow.get().show();
      },
      properties: { style: "toolbutton" },
    });
    k.list = k.listGrp.addListbox();
    k.list.onDoubleClick = E;
    k.list.addEventListener("click", function (i) {
      if (!this.selection) {
        return;
      }
      var n = this.selection.tool;
      if (i.button === 2) {
        var j = [i.screenX, i.screenY];
        if (!k.contextMenu) {
          k.contextMenu = tb.ui.contextMenu(j);
        } else {
          k.contextMenu.frameLocation = j;
        }
        k.contextMenu.load(n, tb.getModifiers());
        k.contextMenu.show();
      }
    });
    k.list.addEventListener("keydown", function (i) {
      var n = i.keyIdentifier;
      if (n === "Enter") {
        k.list.onDoubleClick();
      }
    ...
    A.btns.addIconButton({
      image: tb.ui.icon.close,
      maximumSize: [20, 20],
      onClick: J,
      properties: { style: "toolbutton" },
    });
    k.maximizeButton = A.btns.addIconButton({
      image: tb.ui.icon.maximize,
      maximumSize: [20, 20],
      onClick: function () {
        if (!A.up) {
          A.up = true;
          A.alignment("fill", "top");
          n.orientation("stack");
          k.listGrp.visible(false);
          i = n.size().height;
          L(i);
          this.icon = tb.ui.icon.minimize;
        } else {
          A.alignment("fill", "bottom");
          A.up = false;
          n.orientation("column");
          k.listGrp.visible(true);
          i = f.size.height + A.btns.obj.size.height;
          L(i);
          this.icon = tb.ui.icon.maximize;
        }
        I.update();
      },
      properties: { style: "toolbutton" },
    ...
    m();
    var B = 0;
    globalToolbox.launcher.loadCmd = function (i, n) {
      if (f) {
        h();
      }
      F(n, i);
    ...
    I.show();
    k.loadTools = function (i) {
      k.tools = i;
      k.searchfield.notify();
    };
    tb.init();
    k.loadTools(tb.tools.all);
    tb.registerRefreshHandler(function () {
      k.loadTools(tb.tools.all);
    }, n.obj);
    tb.registerSoftRefreshHandler(function () {
      tb.tools.all.sort(tb.toolSorter);
      k.loadTools(tb.tools.all);
    }, n.obj);
    if (tb.settings.updateOnLaunch) {
      k.updateInfo = tb.update.check("tl_list");
      k.updateAvailable = k.updateInfo !== false;
      k.updateTool = {
        cmd: function () {
          tb.update.openUpdateInfo(k.updateInfo, k.filename);
        },
        isTLupdateTool: true,
        name: "Update for " + tb.script.name + " Available!",
      };
      k.searchfield.notify();
    }
    var N = function (n) {
      ...
      m.set({
        ...
        psuedoOnFocus: function () {
          ...
          if (m.current) {
            ...
            if (typeof toolbarPal !== "undefined" && toolbarPal.settings) {
              k = toolbarPal.settings.lastUsedToolbar;
            }
          }
      ...
      if (typeof toolbarPal !== "undefined") {
        (function () {
          function k() {
            var i = f();
            aeq.extend(toolbarPal.size, i);
            h();
          }
          function A() {
          ...
          n.update = function () {
            aeq.forEach(toolbarPal.size, function (i, n) {
              var j = I[i];
              if (j !== undefined) {
                j.value = n;
                j.et.text = n;
          ...
          m.update = function () {
            m.checkbox.value = toolbarPal.settings.hideToolbarSelect;
            m.toolbutton.value = toolbarPal.settings.toolbutton;
          };
          m.checkbox = m.addCheckbox({
            onClick: function () {
              toolbarPal.settings.hideToolbarSelect = this.value;
              toolbarPal.softRefresh();
            },
          ...
          m.toolbutton = m.addCheckbox({
            onClick: function () {
              toolbarPal.settings.toolbutton = this.value;
              toolbarPal.softRefresh();
            },
    ...
    if (tb.configMissing) {
      k.settingsWindow = N();
      k.settingsWindow.tabs.obj.selection = 1;
      k.settingsWindow.obj.show();
    }
  })();
};
rgTLList(this);
