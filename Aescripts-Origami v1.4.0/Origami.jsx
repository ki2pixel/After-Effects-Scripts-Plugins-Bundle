...
function a(vars) {
  ...
  var maxUIButtons = 3;
  var licV = 2;
  var wx = __BLOB__BLOB_000450__;
  var mx = __BLOB__BLOB_000451__;
...
origami.iconsBinaries = [
  __BLOB__BLOB_000452__,
  __BLOB__BLOB_000453__,
  __BLOB__BLOB_000454__,
  __BLOB__BLOB_000455__,
];
origami.buildWatUI = function (thisObj) {
  ...
  var logoFile = [__BLOB__BLOB_000456__];
  var fldr = new Folder(Folder.userData.fullName + "/Aescripts/origami/");
  fldr.create();
...
origami.Generator_FFX = function (new_arr0, myName) {
  ...
  function HexEncodeURI(number, length_) {
    var length = length_;
    var URLdata = __BLOB__BLOB_000457__;
    if (length == null || length == undefined) {
      var length = 1;
    }
